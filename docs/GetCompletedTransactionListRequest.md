...
# Io.Gate.GateApi.Model.GetCompletedTransactionListRequest
...
**QueryDispute** | **int** | Whether to flag dispute status in the response. &#x60;1&#x60;: yes; &#x60;0&#x60;: no. | [optional] 
**Page** | **int** | Page number starting at 1; values below 1 are treated as 1. | [optional] 
**PerPage** | **int** | Orders per page; default 10, max 200. | [optional] 
