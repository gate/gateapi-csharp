...
# Io.Gate.GateApi.Model.FlashSwapMultiCurrencyPreviewOrder
...
**HedgeType** | **int** | Hedge type | [optional] 
...
**ValidTimestamp** | **long** | Quote expiration timestamp (in seconds) | [optional] 
