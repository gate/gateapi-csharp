...
namespace Example
{
    public class GetPartnerAgentDataAggregatedExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new RebateApi(config);
            var startDate = "2024-01-01 00:00:00";  // string | Query start time, format: yyyy-mm-dd hh:ii:ss (UTC+8). If omitted, defaults to the start of the last 7 days. (optional) 
            var endDate = "2024-01-07 23:59:59";  // string | Query end time, format: yyyy-mm-dd hh:ii:ss (UTC+8). If omitted, defaults to the end of the last 7 days. (optional) 
