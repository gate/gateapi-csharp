...
# Io.Gate.GateApi.Model.CrossexPosition
...
**IsolatedMargin** | **string** | Isolated margin. It is 0 in cross margin mode and applies only to isolated margin positions | [optional] 
...
**LiqPrice** | **string** | Liquidation price. It is 0 in cross margin mode and applies only to isolated margin positions; 0 in isolated margin mode means the position will not be liquidated | [optional] 
...
**FundingFee** | **string** | Accumulated position funding fee. A positive value indicates a gain, while a negative value indicates a loss. | [optional] 
