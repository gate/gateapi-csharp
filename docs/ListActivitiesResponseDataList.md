...
# Io.Gate.GateApi.Model.ListActivitiesResponseDataList
...
------------ | ------------- | ------------- | -------------
**Id** | **int** | Activity ID | 
**TypeId** | **int** | Activity type ID | 
**TypeName** | **string** | Activity type name | 
**CompetitionName** | **string** | Activity name | 
**StartAt** | **int** | Activity start time (Unix timestamp, in seconds) | 
**EndAt** | **int** | Activity end time (Unix timestamp, in seconds) | 
...
**TopId** | **int** | Pin ID, 0 means not pinned | 
**ParentId** | **int** | Parent activity ID, 0 means no parent activity | 
