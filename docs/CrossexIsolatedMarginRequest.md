...
# Io.Gate.GateApi.Model.CrossexIsolatedMarginRequest
...
**PositionSide** | **string** | Position side (NONE/LONG/SHORT). Defaults to NONE for one-way positions if omitted | [optional] 
