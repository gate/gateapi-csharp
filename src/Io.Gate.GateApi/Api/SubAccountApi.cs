...
namespace Io.Gate.GateApi.Api
{
    ...
    public interface ISubAccountApiSync : IApiAccessor
    {
        ...
        /// <param name="type">Enter &#x60;0&#x60; to list all types of sub-accounts (currently supporting cross-margin sub-accounts and regular sub-accounts). Enter &#x60;1&#x60; to query regular sub-accounts only. If no parameter is passed, only regular sub-accounts will be queried by default. (optional)</param>
        ...
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="userId">Sub-account user ID</param>
        /// <param name="key">Sub-account API key</param>
        /// <returns>SubAccountKey</returns>
    ...
    public partial class SubAccountApi : ISubAccountApi
    {
        ...
        /// <summary>
        /// Get sub-account mode Unified account mode: - &#x60;classic&#x60;: Classic account mode - &#x60;multi_currency&#x60;: Cross-currency margin mode - &#x60;portfolio&#x60;: Portfolio margin mode - &#x60;single_currency&#x60;: Single-currency margin mode
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>List&lt;SubUserMode&gt;</returns>
