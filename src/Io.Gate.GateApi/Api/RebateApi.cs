...
namespace Io.Gate.GateApi.Api
{
    ...
    public partial class RebateApi : IRebateApi
    {
        ...
        /// <summary>
        /// Broker obtains transaction history of recommended users Record query time range cannot exceed 30 days
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="currencyPair">Specify the trading pair. If not specified, returns all trading pairs (optional)</param>
        /// <param name="userId">User ID. If not specified, all user records will be returned (optional)</param>
        ...
        /// <summary>
        /// Broker obtains rebate history of recommended users Record query time range cannot exceed 30 days
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="currency">Specify the currency. If not specified, returns all currencies (optional)</param>
        /// <param name="userId">User ID. If not specified, all user records will be returned (optional)</param>
        ...
        /// <summary>
        /// Partner obtains transaction history of recommended users Record query time range cannot exceed 30 days
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="currencyPair">Specify the trading pair. If not specified, returns all trading pairs (optional)</param>
        /// <param name="userId">User ID. If not specified, all user records will be returned (optional)</param>
        ...
        /// <summary>
        /// Partner obtains rebate records of recommended users Record query time range cannot exceed 30 days
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="currency">Specify the currency. If not specified, returns all currencies (optional)</param>
        /// <param name="userId">User ID. If not specified, all user records will be returned (optional)</param>
        ...
        /// <summary>
        /// Partner subordinate list Including sub-agents, direct customers, and indirect customers
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="userId">User ID. If not specified, all user records will be returned (optional)</param>
        /// <param name="limit">Maximum number of records returned in a single list (optional, default to 100)</param>
        ...
        /// <summary>
        /// Broker obtains user&#39;s rebate records Record query time range cannot exceed 30 days
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="limit">Maximum number of records returned in a single list (optional, default to 100)</param>
        /// <param name="offset">List offset, starting from 0 (optional, default to 0)</param>
        ...
        /// <summary>
        /// Broker obtains user&#39;s trading history Record query time range cannot exceed 30 days
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="limit">Maximum number of records returned in a single list (optional, default to 100)</param>
        /// <param name="offset">List offset, starting from 0 (optional, default to 0)</param>
        ...
        /// <summary>
        /// User subordinate relationship Query whether the specified user is within the system
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="userIdList">Query user ID list, separated by commas. If more than 100, only 100 will be returned</param>
        /// <returns>UserSubRelation</returns>
