...
namespace Io.Gate.GateApi.Api
{
    ...
    public interface IMultiCollateralLoanApiSync : IApiAccessor
    {
        ...
        /// <param name="sort">Sort type: time_desc - Default descending by creation time, ltv_asc - Ascending by LTV ratio, ltv_desc - Descending by LTV ratio (optional)</param>
        ...
        /// <param name="from">Start timestamp for the query (optional)</param>
        /// <param name="to">End timestamp for the query, defaults to current time if not specified (optional)</param>
        /// <param name="collateralCurrency">Collateral currency (optional)</param>
        ...
        /// </remarks>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="type">Currency type: collateral - Collateral currency, borrow - Borrowing currency</param>
        /// <param name="currency">When it is a collateral currency, multiple currencies can be passed separated by commas; when it is a borrowing currency, only one currency can be passed</param>
    ...
    public partial class MultiCollateralLoanApi : IMultiCollateralLoanApi
    {
        ...
        /// <summary>
        /// Query collateralization ratio information Multi-currency collateral ratio is fixed, independent of currency
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>CollateralLtv</returns>
