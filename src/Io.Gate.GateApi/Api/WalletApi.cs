...
namespace Io.Gate.GateApi.Api
{
    ...
    public interface IWalletApiSync : IApiAccessor
    {
        ...
        /// <param name="txId">Transfer operation number, cannot be empty at the same time as client_order_id (optional)</param>
        ...
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="subUid">Sub-account user ID, you can query multiple records separated by &#x60;,&#x60;. If not specified, it will return records of all sub-accounts (optional)</param>
        /// <param name="settle">Query balance of specified settlement currency (optional)</param>
        ...
        /// <param name="settle">Specify the settlement currency of the contract to get more accurate fee settings.  This field is optional. Generally, the fee settings for all settlement currencies are the same. (optional)</param>
        ...
        /// </remarks>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="currency">Target currency type for statistical conversion. Accepts BTC, CNY, USD, and USDT. USDT is the default value (optional, default to &quot;USDT&quot;)</param>
        ...
        /// </remarks>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="currency">Currency to convert (optional)</param>
        /// <param name="page">Page number (optional, default to 1)</param>
        ...
        /// <param name="from">Start time for querying records. If not specified, defaults to 7 days before the current time. Unix timestamp in seconds (optional)</param>
        /// <param name="to">End time for querying records. If not specified, defaults to the current time. Unix timestamp in seconds (optional)</param>
        /// <param name="limit">Maximum number of items returned in the list, default value is 100 (optional, default to 100)</param>
        /// <param name="offset">List offset, starting from 0 (optional, default to 0)</param>
    ...
    public partial class WalletApi : IWalletApi
    {
        ...
        /// <summary>
        /// Get withdrawal records Record query time range cannot exceed 30 days
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="currency">Specify the currency. If not specified, returns all currencies (optional)</param>
        /// <param name="withdrawId">Withdrawal record ID starts with &#39;w&#39;, such as: w1879219868. When withdraw_id is not empty, only this specific withdrawal record will be queried, and time-based querying will be disabled (optional)</param>
        ...
        /// <summary>
        /// Get deposit records Record query time range cannot exceed 30 days
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="currency">Specify the currency. If not specified, returns all currencies (optional)</param>
        /// <param name="from">Start time for querying records, defaults to 7 days before current time if not specified (optional)</param>
        ...
        /// <summary>
        /// Transfer between trading accounts Balance transfers between personal trading accounts. Currently supports the following transfer operations:  1. Spot account - Margin account 2. Spot account - Perpetual futures account 3. Spot account - Delivery futures account 4. Spot account - Options account
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="transfer"></param>
        /// <returns>TransactionID</returns>
        ...
        /// <summary>
        /// Get transfer records between main and sub accounts Record query time range cannot exceed 30 days  &gt; Note: Only records after 2020-04-10 can be retrieved
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="subUid">Sub-account user ID, you can query multiple records separated by &#x60;,&#x60;. If not specified, it will return records of all sub-accounts (optional)</param>
        /// <param name="from">Start time for querying records, defaults to 7 days before current time if not specified (optional)</param>
        ...
        /// <summary>
        /// Transfer between main and sub accounts Supports transfers to/from sub-account&#39;s spot or futures accounts. Note that regardless of which sub-account is operated, only the main account&#39;s spot account is used
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="subAccountTransfer"></param>
        /// <returns>TransactionID</returns>
        ...
        /// <summary>
        /// Transfer between sub-accounts Supports balance transfers between two sub-accounts under the same main account. You can use either the main account&#39;s API Key or the source sub-account&#39;s API Key to perform the operation
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="subAccountToSubAccount"></param>
        /// <returns>TransactionID</returns>
        ...
        /// <summary>
        /// Query personal account totals This query endpoint returns the total *estimated value* of all currencies in each account converted to the input currency. Exchange rates and related account balance information may be cached for up to 1 minute. It is not recommended to use this interface data for real-time calculations.  For real-time calculations, query the corresponding balance interface based on account type, such as:  - &#x60;GET /spot/accounts&#x60; to query spot account - &#x60;GET /margin/accounts&#x60; to query margin account - &#x60;GET /futures/{settle}/accounts&#x60; to query futures account
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="currency">Target currency type for statistical conversion. Accepts BTC, CNY, USD, and USDT. USDT is the default value (optional, default to &quot;USDT&quot;)</param>
        /// <returns>TotalBalance</returns>
