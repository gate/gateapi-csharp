...
namespace Io.Gate.GateApi.Api
{
    ...
    public interface IMarginApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="currency">Query history for specified currency. If &#x60;currency&#x60; is specified, &#x60;currency_pair&#x60; must also be specified. (optional)</param>
        /// <param name="currencyPair">Specify margin account currency pair. Used in combination with &#x60;currency&#x60;. Ignored if &#x60;currency&#x60; is not specified (optional)</param>
        ...
        /// </remarks>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="status">Whether to enable auto repayment: &#x60;on&#x60; - enabled, &#x60;off&#x60; - disabled</param>
        /// <returns>AutoRepaySetting</returns>
        ...
        /// <param name="currency">Query by specified currency, includes all currencies if not specified (optional)</param>
        /// <param name="limit">Maximum number of records returned in a single list (optional, default to 100)</param>
    ...
    public partial class MarginApi : IMarginApi
    {
        ...
        /// <summary>
        /// Query margin account balance change history Currently only provides transfer history to and from margin accounts. Query time range cannot exceed 30 days
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="currency">Query history for specified currency. If &#x60;currency&#x60; is specified, &#x60;currency_pair&#x60; must also be specified. (optional)</param>
        /// <param name="currencyPair">Specify margin account currency pair. Used in combination with &#x60;currency&#x60;. Ignored if &#x60;currency&#x60; is not specified (optional)</param>
        ...
        /// <summary>
        /// Query user&#39;s isolated margin account list Supports querying risk ratio isolated accounts and margin ratio isolated accounts
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="currencyPair">Currency pair (optional)</param>
        /// <returns>List&lt;MarginAccount&gt;</returns>
        ...
        /// <summary>
        /// Query cross margin borrow history (deprecated) Sorted by creation time in descending order by default. Set &#x60;reverse&#x3D;false&#x60; for ascending order
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="status">Filter by status. Supported values are 2 and 3. (deprecated.)</param>
        /// <param name="currency">Query by specified currency, includes all currencies if not specified (optional)</param>
        ...
        /// <summary>
        /// Retrieve cross margin repayments. (deprecated) Sorted by creation time in descending order by default. Set &#x60;reverse&#x3D;false&#x60; for ascending order
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="currency"> (optional)</param>
        /// <param name="loanId"> (optional)</param>
