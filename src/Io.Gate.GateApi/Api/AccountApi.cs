...
namespace Io.Gate.GateApi.Api
{
    ...
    public interface IAccountApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="name">Fuzzy search by name (optional)</param>
        ...
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="stpId">STP Group ID</param>
        /// <param name="userId">STP user IDs, multiple IDs can be separated by commas</param>
        /// <returns>List&lt;StpGroupUser&gt;</returns>
    ...
    public partial class AccountApi : IAccountApi
    {
        ...
        /// <summary>
        /// Query STP user groups created by the user Only query STP user groups created by the current main account
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="name">Fuzzy search by name (optional)</param>
        /// <returns>List&lt;StpGroup&gt;</returns>
        ...
        /// <summary>
        /// Create STP user group Only the main account is allowed to create a new STP user group
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="stpGroup"></param>
        /// <returns>StpGroup</returns>
        ...
        /// <summary>
        /// Add users to the STP user group - Only the main account that created this STP group can add users to the STP user group - Only accounts under the current main account are allowed, cross-main account is not permitted
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="stpId">STP Group ID</param>
        /// <param name="requestBody">User ID</param>
        ...
        /// <summary>
        /// Delete users from the STP user group - Only the main account that created this STP group is allowed to delete users from the STP user group - Deletion is limited to accounts under the current main account; cross-account deletion is not permitted
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="stpId">STP Group ID</param>
        /// <param name="userId">STP user IDs, multiple IDs can be separated by commas</param>
        ...
        /// <summary>
        /// Query GT fee deduction configuration Query the GT fee deduction configuration for the current account
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>DebitFee</returns>
        ...
        /// <summary>
        /// Configure GT fee deduction Enable or disable GT fee deduction for the current account
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="debitFee"></param>
        /// <returns></returns>
