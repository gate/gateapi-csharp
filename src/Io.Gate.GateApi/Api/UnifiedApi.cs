...
namespace Io.Gate.GateApi.Api
{
    ...
    public interface IUnifiedApiSync : IApiAccessor
    {
        ...
        /// <param name="type">Loan type: platform borrowing - platform, margin borrowing - margin (optional)</param>
        ...
        /// </remarks>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="type">Loan record type: borrow - borrowing, repay - repayment (optional)</param>
        /// <param name="currency">Query by specified currency name (optional)</param>
        /// <param name="page">Page number (optional, default to 1)</param>
        /// <param name="limit">Maximum number of items returned. Default: 100, minimum: 1, maximum: 100 (optional, default to 100)</param>
        ...
        /// <param name="type">Loan type: platform borrowing - platform, margin borrowing - margin. Defaults to margin if not specified (optional)</param>
        ...
        /// <returns>List&lt;UnifiedLeverageSetting&gt;</returns>
        List<UnifiedLeverageSetting> GetUserLeverageCurrencySetting (string currency = default(string));
        ...
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="currency">Currency (optional)</param>
        /// <returns>ApiResponse of List&lt;UnifiedLeverageSetting&gt;</returns>
        ApiResponse<List<UnifiedLeverageSetting>> GetUserLeverageCurrencySettingWithHttpInfo (string currency = default(string));
        /// <summary>
        ...
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="currency">Currency</param>
        /// <param name="tier">VIP level for the floating rate to be queried (optional)</param>
        /// <param name="page">Page number (optional, default to 1)</param>
        /// <param name="limit">Maximum number of items returned. Default: 100, minimum: 1, maximum: 100 (optional, default to 100)</param>
    ...
    public interface IUnifiedApiAsync : IApiAccessor
    {
        ...
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="currency">Currency (optional)</param>
        /// <returns>Task of List&lt;UnifiedLeverageSetting&gt;</returns>
        Task<List<UnifiedLeverageSetting>> GetUserLeverageCurrencySettingAsync (string currency = default(string));
        ...
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="currency">Currency (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;UnifiedLeverageSetting&gt;)</returns>
        Task<ApiResponse<List<UnifiedLeverageSetting>>> GetUserLeverageCurrencySettingAsyncWithHttpInfo (string currency = default(string));
        /// <summary>
        /// Set loan currency leverage
        /// </summary>
        /// <remarks>
    ...
    public partial class UnifiedApi : IUnifiedApi
    {
        ...
        /// <summary>
        /// Borrow or repay When borrowing, ensure the borrowed amount is not below the minimum borrowing threshold for the specific cryptocurrency and does not exceed the maximum borrowing limit set by the platform and user.  Loan interest will be automatically deducted from the account at regular intervals. Users are responsible for managing repayment of borrowed amounts.  For repayment, use &#x60;repaid_all&#x3D;true&#x60; to repay all available amounts
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="unifiedLoan"></param>
        /// <returns>UnifiedLoanResult</returns>
        ...
        /// <summary>
        /// Get user risk unit details Get user risk unit details, only valid in portfolio margin mode
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>UnifiedRiskUnits</returns>
        ...
        /// <summary>
        /// Query unified account estimated interest rate Interest rates fluctuate hourly based on lending depth, so exact rates cannot be provided. When a currency is not supported, the interest rate returned will be an empty string
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="currencies">Specify currency names for querying in an array, separated by commas, maximum 10 currencies</param>
        /// <returns>Dictionary&lt;string, string&gt;</returns>
        ...
        /// <param name="currency">Currency (optional)</param>
        /// <returns>List&lt;UnifiedLeverageSetting&gt;</returns>
        public List<UnifiedLeverageSetting> GetUserLeverageCurrencySetting (string currency = default(string))
        {
             ApiResponse<List<UnifiedLeverageSetting>> localVarResponse = GetUserLeverageCurrencySettingWithHttpInfo(currency);
             return localVarResponse.Data;
        }
        ...
        /// <param name="currency">Currency (optional)</param>
        /// <returns>ApiResponse of List&lt;UnifiedLeverageSetting&gt;</returns>
        public ApiResponse<List<UnifiedLeverageSetting>> GetUserLeverageCurrencySettingWithHttpInfo (string currency = default(string))
        {
            RequestOptions localVarRequestOptions = new RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<List<UnifiedLeverageSetting>>("/unified/leverage/user_currency_setting", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="currency">Currency (optional)</param>
        /// <returns>Task of List&lt;UnifiedLeverageSetting&gt;</returns>
        public async Task<List<UnifiedLeverageSetting>> GetUserLeverageCurrencySettingAsync (string currency = default(string))
        {
             Io.Gate.GateApi.Client.ApiResponse<List<UnifiedLeverageSetting>> localVarResponse = await GetUserLeverageCurrencySettingAsyncWithHttpInfo(currency);
             return localVarResponse.Data;
        ...
        /// <param name="currency">Currency (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;UnifiedLeverageSetting&gt;)</returns>
        public async Task<ApiResponse<List<UnifiedLeverageSetting>>> GetUserLeverageCurrencySettingAsyncWithHttpInfo (string currency = default(string))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<UnifiedLeverageSetting>>("/unified/leverage/user_currency_setting", localVarRequestOptions, this.Configuration);
