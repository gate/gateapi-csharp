...
namespace Io.Gate.GateApi.Api
{
    ...
    public interface IMarginUniApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="currencies">Array of currency names to query, maximum 10</param>
    ...
    public partial class MarginUniApi : IMarginUniApi
    {
        ...
        /// <summary>
        /// Estimate interest rate for isolated margin currencies Interest rates change hourly based on lending depth, so completely accurate rates cannot be provided.
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="currencies">Array of currency names to query, maximum 10</param>
        /// <returns>Dictionary&lt;string, string&gt;</returns>
