...
namespace Io.Gate.GateApi.Api
{
    ...
    public interface IOptionsApiSync : IApiAccessor
    {
        ...
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="underlying">Underlying (Obtained by listing underlying endpoint)</param>
        /// <param name="expiration">Unix timestamp of expiration date (optional)</param>
        ...
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="contract">Options contract name (optional)</param>
        /// <param name="type">&#x60;C&#x60; for call, &#x60;P&#x60; for put (optional)</param>
        /// <param name="limit">Maximum number of records returned in a single list (optional, default to 100)</param>
        /// <param name="offset">List offset, starting from 0 (optional, default to 0)</param>
        /// <param name="from">Start timestamp  Specify start time, time format is Unix timestamp. If not specified, it defaults to (the data start time of the time range actually returned by to and limit) (optional)</param>
        /// <param name="to">Termination Timestamp  Specify the end time. If not specified, it defaults to the current time, and the time format is a Unix timestamp (optional)</param>
        ...
        /// <param name="from">Start timestamp  Specify start time, time format is Unix timestamp. If not specified, it defaults to (the data start time of the time range actually returned by to and limit) (optional)</param>
        /// <param name="to">Termination Timestamp  Specify the end time. If not specified, it defaults to the current time, and the time format is a Unix timestamp (optional)</param>
        /// <param name="type">Change types: - dnw: Deposit &amp; Withdrawal - prem: Trading premium - fee: Trading fee - refr: Referrer rebate - set: Settlement P&amp;L (optional)</param>
        ...
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="orderId">Order ID returned when order is successfully created</param>
        /// <param name="amendOptionsOrderRequest"></param>
        /// <returns>OptionsOrder</returns>
        ...
        /// <param name="amendOptionsOrderRequest"></param>
        /// <returns>ApiResponse of OptionsOrder</returns>
        ApiResponse<OptionsOrder> AmendOptionsOrderWithHttpInfo (long orderId, AmendOptionsOrderRequest amendOptionsOrderRequest);
        /// <summary>
        /// Cancel single order
        /// </summary>
        /// <remarks>
    ...
    public interface IOptionsApiAsync : IApiAccessor
    {
        ...
        /// <param name="amendOptionsOrderRequest"></param>
        /// <returns>Task of OptionsOrder</returns>
        Task<OptionsOrder> AmendOptionsOrderAsync (long orderId, AmendOptionsOrderRequest amendOptionsOrderRequest);
        ...
        /// <param name="amendOptionsOrderRequest"></param>
        /// <returns>Task of ApiResponse (OptionsOrder)</returns>
        Task<ApiResponse<OptionsOrder>> AmendOptionsOrderAsyncWithHttpInfo (long orderId, AmendOptionsOrderRequest amendOptionsOrderRequest);
        /// <summary>
        /// Cancel single order
        /// </summary>
        /// <remarks>
    ...
    public partial class OptionsApi : IOptionsApi
    {
        ...
        /// <summary>
        /// Query options contract order book Bids will be sorted by price from high to low, while asks sorted reversely
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="contract">Options contract name</param>
        /// <param name="interval">Price precision for merged depth. 0 means no merging. If not specified, defaults to 0 (optional, default to 0)</param>
        ...
        /// <summary>
        /// Option Order Modification Modify the order price and/or quantity of a specified order; only orders with status &#39;open&#39; are supported
        /// </summary>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="orderId">Order ID returned when order is successfully created</param>
        /// <param name="amendOptionsOrderRequest"></param>
        /// <returns>OptionsOrder</returns>
        public OptionsOrder AmendOptionsOrder (long orderId, AmendOptionsOrderRequest amendOptionsOrderRequest)
        {
             ApiResponse<OptionsOrder> localVarResponse = AmendOptionsOrderWithHttpInfo(orderId, amendOptionsOrderRequest);
             return localVarResponse.Data;
        }
        ...
        /// <param name="amendOptionsOrderRequest"></param>
        /// <returns>ApiResponse of OptionsOrder</returns>
        public ApiResponse<OptionsOrder> AmendOptionsOrderWithHttpInfo (long orderId, AmendOptionsOrderRequest amendOptionsOrderRequest)
        {
            // verify the required parameter 'amendOptionsOrderRequest' is set
            if (amendOptionsOrderRequest == null)
                throw new ApiException(400, "Missing required parameter 'amendOptionsOrderRequest' when calling OptionsApi->AmendOptionsOrder");
            ...
            localVarRequestOptions.PathParameters.Add("order_id", ClientUtils.ParameterToString(orderId)); // path parameter
            localVarRequestOptions.Data = amendOptionsOrderRequest;

            // authentication (apiv4) required
            localVarRequestOptions.RequireApiV4Auth = true;

            // make the HTTP request
            var localVarResponse = this.Client.Put<OptionsOrder>("/options/orders/{order_id}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("AmendOptionsOrder", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="amendOptionsOrderRequest"></param>
        /// <returns>Task of OptionsOrder</returns>
        public async Task<OptionsOrder> AmendOptionsOrderAsync (long orderId, AmendOptionsOrderRequest amendOptionsOrderRequest)
        {
             Io.Gate.GateApi.Client.ApiResponse<OptionsOrder> localVarResponse = await AmendOptionsOrderAsyncWithHttpInfo(orderId, amendOptionsOrderRequest);
             return localVarResponse.Data;
        ...
        /// <param name="amendOptionsOrderRequest"></param>
        /// <returns>Task of ApiResponse (OptionsOrder)</returns>
        public async Task<ApiResponse<OptionsOrder>> AmendOptionsOrderAsyncWithHttpInfo (long orderId, AmendOptionsOrderRequest amendOptionsOrderRequest)
        {
            // verify the required parameter 'amendOptionsOrderRequest' is set
            if (amendOptionsOrderRequest == null)
                throw new ApiException(400, "Missing required parameter 'amendOptionsOrderRequest' when calling OptionsApi->AmendOptionsOrder");
            ...
            var localVarResponse = await this.AsynchronousClient.PutAsync<OptionsOrder>("/options/orders/{order_id}", localVarRequestOptions, this.Configuration);
