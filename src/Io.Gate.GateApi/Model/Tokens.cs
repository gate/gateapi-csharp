...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class Tokens :  IEquatable<Tokens>, IValidatableObject
    {
        ...
        public Tokens(string currency = default(string), string name = default(string), string chain = default(string), string address = default(string), int amountPrecision = default(int), int precision = default(int), int status = default(int))
        {
