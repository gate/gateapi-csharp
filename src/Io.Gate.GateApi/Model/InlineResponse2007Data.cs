...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse2007Data :  IEquatable<InlineResponse2007Data>, IValidatableObject
    {
        ...
        protected InlineResponse2007Data() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007Data" /> class.
        /// </summary>
        ...
        public InlineResponse2007Data(int total = default(int), int pageSize = default(int), int pageNumber = default(int), int totalPage = default(int), List<InlineResponse2007DataList> list = default(List<InlineResponse2007DataList>))
        {
            this.Total = total;
            ...
            this.List = list ?? throw new ArgumentNullException("list", "list is a required property for InlineResponse2007Data and cannot be null");
        }
