...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class Ticker :  IEquatable<Ticker>, IValidatableObject
    {
        ...
        /// <param name="lowestSize">Latest seller&#39;s lowest price quantity; not available for batch queries; available for single queries, empty if no data.</param>
        /// <param name="highestBid">Recent highest bid.</param>
        /// <param name="highestSize">Latest buyer&#39;s highest price quantity; not available for batch queries; available for single queries, empty if no data.</param>
        /// <param name="changePercentage">24h price change percentage (negative for decrease, e.g., -7.45).</param>
        /// <param name="changeUtc0">UTC+0 timezone, 24h price change percentage, negative for decline (e.g., -7.45).</param>
        /// <param name="changeUtc8">UTC+8 timezone, 24h price change percentage, negative for decline (e.g., -7.45).</param>
        /// <param name="baseVolume">Base currency trading volume in the last 24h.</param>
        /// <param name="quoteVolume">Quote currency trading volume in the last 24h.</param>
        /// <param name="high24h">24h High.</param>
        /// <param name="low24h">24h Low.</param>
        /// <param name="etfNetValue">ETF net value.</param>
        /// <param name="etfPreNetValue">ETF net value at previous rebalancing point.</param>
        /// <param name="etfPreTimestamp">ETF previous rebalancing time.</param>
        ...
        /// </summary>
        /// <value>Latest seller&#39;s lowest price quantity; not available for batch queries; available for single queries, empty if no data</value>
        ...
        /// </summary>
        /// <value>Latest buyer&#39;s highest price quantity; not available for batch queries; available for single queries, empty if no data</value>
        ...
        /// </summary>
        /// <value>UTC+0 timezone, 24h price change percentage, negative for decline (e.g., -7.45)</value>
        ...
        /// </summary>
        /// <value>UTC+8 timezone, 24h price change percentage, negative for decline (e.g., -7.45)</value>
        ...
        /// </summary>
        /// <value>Base currency trading volume in the last 24h</value>
        ...
        /// </summary>
        /// <value>Quote currency trading volume in the last 24h</value>
        ...
        /// </summary>
        /// <value>ETF net value at previous rebalancing point</value>
        ...
        /// </summary>
        /// <value>ETF previous rebalancing time</value>
