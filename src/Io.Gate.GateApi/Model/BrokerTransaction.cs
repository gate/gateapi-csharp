...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class BrokerTransaction :  IEquatable<BrokerTransaction>, IValidatableObject
    {
        ...
        /// <param name="fee">Fee amount (USDT).</param>
        ...
        public BrokerTransaction(long transactionTime = default(long), long userId = default(long), string groupName = default(string), string fee = default(string), string currencyPair = default(string), string amount = default(string), string feeAsset = default(string), string source = default(string), BrokerCommissionSubBrokerInfo subBrokerInfo = default(BrokerCommissionSubBrokerInfo), string alphaContractAddr = default(string))
        {
