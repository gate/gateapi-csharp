...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineObject12 :  IEquatable<InlineObject12>, IValidatableObject
    {
        ...
        public InlineObject12(string text = default(string), string symbol = default(string), SideEnum side = default(SideEnum), TypeEnum? type = TypeEnum.LIMIT, TimeInForceEnum? timeInForce = TimeInForceEnum.GTC, string qty = default(string), string price = default(string), string quoteQty = default(string), ReduceOnlyEnum? reduceOnly = default(ReduceOnlyEnum?), PositionSideEnum? positionSide = default(PositionSideEnum?))
        {
            // to ensure "symbol" is required (not null)
            this.Symbol = symbol ?? throw new ArgumentNullException("symbol", "symbol is a required property for InlineObject12 and cannot be null");
            this.Side = side;
            this.Text = text;
            this.Type = type;
        ...
        /// </summary>
        /// <value>Unique Identifier Exchange_Business_Base_Counter Examples: - To place a Spot order for ADA/USDT on BINANCE: Use identifier &#x60;BINANCE_SPOT_ADA_USDT&#x60;;   - To place a USDT-margined Perpetual Futures order for ADA/USDT on OKX: Use identifier &#x60;OKX_FUTURE_ADA_USDT&#x60;;   - To place a Spot Margin order for ADA/USDT on GATE: Use identifier &#x60;GATE_MARGIN_ADA_USDT&#x60;;   - To place a Spot order for ADA/USDT on BYBIT: Use identifier &#x60;BYBIT_SPOT_ADA_USDT&#x60;;   Currently supports three order types: Spot orders, USDT-margined Perpetual Futures orders, and Spot Margin orders. BYBIT does not currently support Spot Margin orders</value>
