...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class CrossexOrderRequest :  IEquatable<CrossexOrderRequest>, IValidatableObject
    {
        ...
        public CrossexOrderRequest(string text = default(string), string symbol = default(string), SideEnum side = default(SideEnum), TypeEnum? type = TypeEnum.LIMIT, TimeInForceEnum? timeInForce = TimeInForceEnum.GTC, string qty = default(string), string price = default(string), string quoteQty = default(string), ReduceOnlyEnum? reduceOnly = default(ReduceOnlyEnum?), PositionSideEnum? positionSide = default(PositionSideEnum?))
        {
            // to ensure "symbol" is required (not null)
            this.Symbol = symbol ?? throw new ArgumentNullException("symbol", "symbol is a required property for CrossexOrderRequest and cannot be null");
            this.Side = side;
            this.Text = text;
            this.Type = type;
        ...
        {
            return this.Equals(input as CrossexOrderRequest);
        }

        /// <summary>
        /// Returns true if CrossexOrderRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CrossexOrderRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrossexOrderRequest input)
        {
            if (input == null)
                return false;
