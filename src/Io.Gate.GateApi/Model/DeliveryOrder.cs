...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class DeliveryOrder :  IEquatable<DeliveryOrder>, IValidatableObject
    {
        ...
        public DeliveryOrder(string contract = default(string), long size = default(long), long iceberg = default(long), string price = default(string), bool close = false, bool reduceOnly = false, TifEnum? tif = TifEnum.Gtc, string text = default(string), AutoSizeEnum? autoSize = default(AutoSizeEnum?), StpActEnum? stpAct = default(StpActEnum?))
        {
            // to ensure "contract" is required (not null)
            this.Contract = contract ?? throw new ArgumentNullException("contract", "contract is a required property for DeliveryOrder and cannot be null");
            this.Size = size;
