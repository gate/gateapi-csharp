...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse20045 :  IEquatable<InlineResponse20045>, IValidatableObject
    {
        ...
        public InlineResponse20045(string id = default(string), string userId = default(string), string businessId = default(string), string type = default(string), string exchangeType = default(string), string coin = default(string), string change = default(string), string balance = default(string), string createTime = default(string))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id", "id is a required property for InlineResponse20045 and cannot be null");
            // to ensure "userId" is required (not null)
            this.UserId = userId ?? throw new ArgumentNullException("userId", "userId is a required property for InlineResponse20045 and cannot be null");
            // to ensure "businessId" is required (not null)
            this.BusinessId = businessId ?? throw new ArgumentNullException("businessId", "businessId is a required property for InlineResponse20045 and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type", "type is a required property for InlineResponse20045 and cannot be null");
            ...
            this.Change = change ?? throw new ArgumentNullException("change", "change is a required property for InlineResponse20045 and cannot be null");
            // to ensure "balance" is required (not null)
            this.Balance = balance ?? throw new ArgumentNullException("balance", "balance is a required property for InlineResponse20045 and cannot be null");
            // to ensure "createTime" is required (not null)
            this.CreateTime = createTime ?? throw new ArgumentNullException("createTime", "createTime is a required property for InlineResponse20045 and cannot be null");
        }
