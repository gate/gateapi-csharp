...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse20045 :  IEquatable<InlineResponse20045>, IValidatableObject
    {
        ...
        public InlineResponse20045(string userId = default(string), string transactionId = default(string), string orderId = default(string), string text = default(string), string symbol = default(string), string exchangeType = default(string), string businessType = default(string), string side = default(string), string qty = default(string), string price = default(string), string fee = default(string), string feeCoin = default(string), string feeRate = default(string), string matchRole = default(string), string rpnl = default(string), string positionMode = default(string), string positionSide = default(string), string createTime = default(string))
        {
            this.UserId = userId;
