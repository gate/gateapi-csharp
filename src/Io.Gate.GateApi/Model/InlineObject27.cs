...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineObject27 :  IEquatable<InlineObject27>, IValidatableObject
    {
        ...
        public InlineObject27(string symbol = default(string), string leverage = default(string))
        {
            // to ensure "symbol" is required (not null)
            this.Symbol = symbol ?? throw new ArgumentNullException("symbol", "symbol is a required property for InlineObject27 and cannot be null");
            // to ensure "leverage" is required (not null)
            this.Leverage = leverage ?? throw new ArgumentNullException("leverage", "leverage is a required property for InlineObject27 and cannot be null");
        }
