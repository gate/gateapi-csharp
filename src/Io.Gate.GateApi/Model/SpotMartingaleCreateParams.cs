...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class SpotMartingaleCreateParams :  IEquatable<SpotMartingaleCreateParams>, IValidatableObject
    {
        ...
        protected SpotMartingaleCreateParams() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SpotMartingaleCreateParams" /> class.
        /// </summary>
        ...
        public SpotMartingaleCreateParams(string investAmount = default(string), string priceDeviation = default(string), int maxOrders = default(int), string takeProfitRatio = default(string), string stopLossPrice = default(string), string profitSharingRatio = default(string))
        {
            ...
            this.PriceDeviation = priceDeviation ?? throw new ArgumentNullException("priceDeviation", "priceDeviation is a required property for SpotMartingaleCreateParams and cannot be null");
        ...
        {
            return this.Equals(input as SpotMartingaleCreateParams);
        }

        /// <summary>
        /// Returns true if SpotMartingaleCreateParams instances are equal
        /// </summary>
        /// <param name="input">Instance of SpotMartingaleCreateParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SpotMartingaleCreateParams input)
        {
            if (input == null)
                return false;
