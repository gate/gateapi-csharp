...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MarginGridCreateParams :  IEquatable<MarginGridCreateParams>, IValidatableObject
    {
        /// <summary>
        /// Defines PriceType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MarginGridCreateParams" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MarginGridCreateParams() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MarginGridCreateParams" /> class.
        /// </summary>
        ...
        public MarginGridCreateParams(string money = default(string), string lowPrice = default(string), string highPrice = default(string), int gridNum = default(int), PriceTypeEnum priceType = default(PriceTypeEnum), string leverage = default(string), FuturesDirection? direction = default(FuturesDirection?), string triggerPrice = default(string), string stopProfit = default(string), string stopLoss = default(string), string profitSharingRatio = default(string), bool isUseBase = default(bool))
        {
            // to ensure "money" is required (not null)
            this.Money = money ?? throw new ArgumentNullException("money", "money is a required property for MarginGridCreateParams and cannot be null");
            // to ensure "lowPrice" is required (not null)
            this.LowPrice = lowPrice ?? throw new ArgumentNullException("lowPrice", "lowPrice is a required property for MarginGridCreateParams and cannot be null");
            // to ensure "highPrice" is required (not null)
            this.HighPrice = highPrice ?? throw new ArgumentNullException("highPrice", "highPrice is a required property for MarginGridCreateParams and cannot be null");
            this.GridNum = gridNum;
            this.PriceType = priceType;
            // to ensure "leverage" is required (not null)
            this.Leverage = leverage ?? throw new ArgumentNullException("leverage", "leverage is a required property for MarginGridCreateParams and cannot be null");
        ...
        {
            return this.Equals(input as MarginGridCreateParams);
        }

        /// <summary>
        /// Returns true if MarginGridCreateParams instances are equal
        /// </summary>
        /// <param name="input">Instance of MarginGridCreateParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MarginGridCreateParams input)
        {
            if (input == null)
                return false;
