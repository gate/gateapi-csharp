...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20022DataLists :  IEquatable<InlineResponse20022DataLists>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20022DataLists" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InlineResponse20022DataLists);
        }

        /// <summary>
        /// Returns true if InlineResponse20022DataLists instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20022DataLists to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20022DataLists input)
        {
            if (input == null)
                return false;
