...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class LedgerRecord :  IEquatable<LedgerRecord>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="LedgerRecord" /> class.
        /// </summary>
        /// <param name="withdrawOrderId">User-defined order number for withdrawal. Default is empty. When not empty, the specified user-defined order number record will be queried.</param>
        ...
        /// <param name="withdrawId">Withdrawal record ID starts with &#39;w&#39;, such as: w1879219868. When withdraw_id is not empty, only this specific withdrawal record will be queried, and time-based querying will be disabled.</param>
        /// <param name="assetClass">Withdrawal record currency type, empty by default. Supports users to query withdrawal records in main area and innovation area on demand. Valid values: SPOT, PILOT  SPOT: Main area PILOT: Innovation area.</param>
        ...
        /// </summary>
        /// <value>User-defined order number for withdrawal. Default is empty. When not empty, the specified user-defined order number record will be queried</value>
        ...
        /// </summary>
        /// <value>Withdrawal record ID starts with &#39;w&#39;, such as: w1879219868. When withdraw_id is not empty, only this specific withdrawal record will be queried, and time-based querying will be disabled</value>
        ...
        /// </summary>
        /// <value>Withdrawal record currency type, empty by default. Supports users to query withdrawal records in main area and innovation area on demand. Valid values: SPOT, PILOT  SPOT: Main area PILOT: Innovation area</value>
