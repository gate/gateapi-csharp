...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20011List :  IEquatable<InlineResponse20011List>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20011List" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InlineResponse20011List);
        }

        /// <summary>
        /// Returns true if InlineResponse20011List instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20011List to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20011List input)
        {
            if (input == null)
                return false;
