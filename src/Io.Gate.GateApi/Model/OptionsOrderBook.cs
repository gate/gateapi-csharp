...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class OptionsOrderBook :  IEquatable<OptionsOrderBook>, IValidatableObject
    {
        ...
        public OptionsOrderBook(long id = default(long), double current = default(double), double update = default(double), List<DeliveryOrderBookItem> asks = default(List<DeliveryOrderBookItem>), List<DeliveryOrderBookItem> bids = default(List<DeliveryOrderBookItem>))
        {
