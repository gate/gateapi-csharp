...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OptionsOrderBook :  IEquatable<OptionsOrderBook>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptionsOrderBook" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OptionsOrderBook() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OptionsOrderBook" /> class.
        /// </summary>
        ...
        public OptionsOrderBook(long id = default(long), double current = default(double), double update = default(double), List<FuturesOrderBookItem1> asks = default(List<FuturesOrderBookItem1>), List<FuturesOrderBookItem1> bids = default(List<FuturesOrderBookItem1>))
        {
            // to ensure "asks" is required (not null)
            this.Asks = asks ?? throw new ArgumentNullException("asks", "asks is a required property for OptionsOrderBook and cannot be null");
            // to ensure "bids" is required (not null)
            this.Bids = bids ?? throw new ArgumentNullException("bids", "bids is a required property for OptionsOrderBook and cannot be null");
            this.Id = id;
        ...
        {
            return this.Equals(input as OptionsOrderBook);
        }

        /// <summary>
        /// Returns true if OptionsOrderBook instances are equal
        /// </summary>
        /// <param name="input">Instance of OptionsOrderBook to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptionsOrderBook input)
        {
            if (input == null)
                return false;
