...
namespace Io.Gate.GateApi.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrossexAccountUpdateRequest" /> class.
        /// </summary>
        ...
        /// <param name="exchangeType">Exchange (&#x60;BINANCE&#x60; / &#x60;OKX&#x60; / &#x60;GATE&#x60; / &#x60;BYBIT&#x60; / &#x60;KRAKEN&#x60; / &#x60;HYPERLIQUID&#x60; / &#x60;DERIBIT&#x60; / &#x60;CROSSEX&#x60;). When account mode is &#x60;ISOLATED_EXCHANGE&#x60;, the exchange must be specified to adjust futures position mode..</param>
        public CrossexAccountUpdateRequest(string positionMode = default(string), string accountMode = default(string), string exchangeType = default(string))
        {
        ...
        /// </summary>
        /// <value>Exchange (&#x60;BINANCE&#x60; / &#x60;OKX&#x60; / &#x60;GATE&#x60; / &#x60;BYBIT&#x60; / &#x60;KRAKEN&#x60; / &#x60;HYPERLIQUID&#x60; / &#x60;DERIBIT&#x60; / &#x60;CROSSEX&#x60;). When account mode is &#x60;ISOLATED_EXCHANGE&#x60;, the exchange must be specified to adjust futures position mode.</value>
        ...
        {
            return this.Equals(input as CrossexAccountUpdateRequest);
        }

        /// <summary>
        /// Returns true if CrossexAccountUpdateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CrossexAccountUpdateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrossexAccountUpdateRequest input)
        {
            if (input == null)
                return false;
