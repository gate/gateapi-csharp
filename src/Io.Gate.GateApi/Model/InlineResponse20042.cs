...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse20042 :  IEquatable<InlineResponse20042>, IValidatableObject
    {
        ...
        public InlineResponse20042(string userId = default(string), string symbol = default(string), string interestId = default(string), string liabilityId = default(string), string liability = default(string), string liabilityCoin = default(string), string interest = default(string), string interestRate = default(string), string interestType = default(string), string createTime = default(string), string exchangeType = default(string))
        {
            // to ensure "userId" is required (not null)
            this.UserId = userId ?? throw new ArgumentNullException("userId", "userId is a required property for InlineResponse20042 and cannot be null");
            // to ensure "symbol" is required (not null)
            this.Symbol = symbol ?? throw new ArgumentNullException("symbol", "symbol is a required property for InlineResponse20042 and cannot be null");
            // to ensure "interestId" is required (not null)
            this.InterestId = interestId ?? throw new ArgumentNullException("interestId", "interestId is a required property for InlineResponse20042 and cannot be null");
            // to ensure "liabilityId" is required (not null)
            this.LiabilityId = liabilityId ?? throw new ArgumentNullException("liabilityId", "liabilityId is a required property for InlineResponse20042 and cannot be null");
            // to ensure "liability" is required (not null)
            this.Liability = liability ?? throw new ArgumentNullException("liability", "liability is a required property for InlineResponse20042 and cannot be null");
            // to ensure "liabilityCoin" is required (not null)
            this.LiabilityCoin = liabilityCoin ?? throw new ArgumentNullException("liabilityCoin", "liabilityCoin is a required property for InlineResponse20042 and cannot be null");
            // to ensure "interest" is required (not null)
            this.Interest = interest ?? throw new ArgumentNullException("interest", "interest is a required property for InlineResponse20042 and cannot be null");
            // to ensure "interestRate" is required (not null)
            this.InterestRate = interestRate ?? throw new ArgumentNullException("interestRate", "interestRate is a required property for InlineResponse20042 and cannot be null");
            // to ensure "interestType" is required (not null)
            this.InterestType = interestType ?? throw new ArgumentNullException("interestType", "interestType is a required property for InlineResponse20042 and cannot be null");
            // to ensure "createTime" is required (not null)
            this.CreateTime = createTime ?? throw new ArgumentNullException("createTime", "createTime is a required property for InlineResponse20042 and cannot be null");
            // to ensure "exchangeType" is required (not null)
            this.ExchangeType = exchangeType ?? throw new ArgumentNullException("exchangeType", "exchangeType is a required property for InlineResponse20042 and cannot be null");
        }
