...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PlaceDualInvestmentOrderParams :  IEquatable<PlaceDualInvestmentOrderParams>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlaceDualInvestmentOrderParams" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PlaceDualInvestmentOrderParams() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PlaceDualInvestmentOrderParams" /> class.
        /// </summary>
        ...
        public PlaceDualInvestmentOrderParams(string planId = default(string), string amount = default(string), string text = default(string))
        {
            ...
            this.PlanId = planId ?? throw new ArgumentNullException("planId", "planId is a required property for PlaceDualInvestmentOrderParams and cannot be null");
            // to ensure "amount" is required (not null)
            this.Amount = amount ?? throw new ArgumentNullException("amount", "amount is a required property for PlaceDualInvestmentOrderParams and cannot be null");
            this.Text = text;
        }
        ...
        {
            return this.Equals(input as PlaceDualInvestmentOrderParams);
        }

        /// <summary>
        /// Returns true if PlaceDualInvestmentOrderParams instances are equal
        /// </summary>
        /// <param name="input">Instance of PlaceDualInvestmentOrderParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlaceDualInvestmentOrderParams input)
        {
            if (input == null)
                return false;
