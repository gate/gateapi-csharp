...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class TransferOrderStatus :  IEquatable<TransferOrderStatus>, IValidatableObject
    {
        ...
        /// <param name="status">Transfer status: PENDING - Processing, SUCCESS - Transfer successful, FAIL - Transfer failed, PARTIAL_SUCCESS - Partially successful (this status appears when transferring between sub-accounts).</param>
        ...
        /// </summary>
        /// <value>Transfer status: PENDING - Processing, SUCCESS - Transfer successful, FAIL - Transfer failed, PARTIAL_SUCCESS - Partially successful (this status appears when transferring between sub-accounts)</value>
