...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class SpotGridCreateParams :  IEquatable<SpotGridCreateParams>, IValidatableObject
    {
        ...
        protected SpotGridCreateParams() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SpotGridCreateParams" /> class.
        /// </summary>
        ...
        public SpotGridCreateParams(string money = default(string), string lowPrice = default(string), string highPrice = default(string), int gridNum = default(int), PriceTypeEnum priceType = default(PriceTypeEnum), string triggerPrice = default(string), string stopProfit = default(string), string stopLoss = default(string), string profitSharingRatio = default(string), bool isUseBase = default(bool))
        {
            // to ensure "money" is required (not null)
            this.Money = money ?? throw new ArgumentNullException("money", "money is a required property for SpotGridCreateParams and cannot be null");
            // to ensure "lowPrice" is required (not null)
            this.LowPrice = lowPrice ?? throw new ArgumentNullException("lowPrice", "lowPrice is a required property for SpotGridCreateParams and cannot be null");
            // to ensure "highPrice" is required (not null)
            this.HighPrice = highPrice ?? throw new ArgumentNullException("highPrice", "highPrice is a required property for SpotGridCreateParams and cannot be null");
        ...
        {
            return this.Equals(input as SpotGridCreateParams);
        }

        /// <summary>
        /// Returns true if SpotGridCreateParams instances are equal
        /// </summary>
        /// <param name="input">Instance of SpotGridCreateParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SpotGridCreateParams input)
        {
            if (input == null)
                return false;
