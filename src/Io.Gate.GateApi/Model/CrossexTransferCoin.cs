...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CrossexTransferCoin :  IEquatable<CrossexTransferCoin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrossexTransferCoin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CrossexTransferCoin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CrossexTransferCoin" /> class.
        /// </summary>
        ...
        public CrossexTransferCoin(string coin = default(string), decimal minTransAmount = default(decimal), decimal estFee = default(decimal), int precision = default(int), int isDisabled = default(int))
        {
            // to ensure "coin" is required (not null)
            this.Coin = coin ?? throw new ArgumentNullException("coin", "coin is a required property for CrossexTransferCoin and cannot be null");
        ...
        {
            return this.Equals(input as CrossexTransferCoin);
        }

        /// <summary>
        /// Returns true if CrossexTransferCoin instances are equal
        /// </summary>
        /// <param name="input">Instance of CrossexTransferCoin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrossexTransferCoin input)
        {
            if (input == null)
                return false;
