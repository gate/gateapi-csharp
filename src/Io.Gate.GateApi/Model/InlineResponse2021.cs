...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse2021 :  IEquatable<InlineResponse2021>, IValidatableObject
    {
        ...
        public InlineResponse2021(string symbol = default(string), string leverage = default(string))
        {
            // to ensure "symbol" is required (not null)
            this.Symbol = symbol ?? throw new ArgumentNullException("symbol", "symbol is a required property for InlineResponse2021 and cannot be null");
            // to ensure "leverage" is required (not null)
            this.Leverage = leverage ?? throw new ArgumentNullException("leverage", "leverage is a required property for InlineResponse2021 and cannot be null");
        }
