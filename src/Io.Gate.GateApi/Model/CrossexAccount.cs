...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CrossexAccount :  IEquatable<CrossexAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrossexAccount" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CrossexAccount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CrossexAccount" /> class.
        /// </summary>
        ...
        public CrossexAccount(string userId = default(string), string availableMargin = default(string), string marginBalance = default(string), string initialMargin = default(string), string maintenanceMargin = default(string), string initialMarginRate = default(string), string maintenanceMarginRate = default(string), string positionMode = default(string), string accountLimit = default(string), string createTime = default(string), string updateTime = default(string), string accountMode = default(string), string exchangeType = default(string), List<CrossexAccountAsset> assets = default(List<CrossexAccountAsset>))
        {
            ...
            this.UserId = userId ?? throw new ArgumentNullException("userId", "userId is a required property for CrossexAccount and cannot be null");
            // to ensure "availableMargin" is required (not null)
            this.AvailableMargin = availableMargin ?? throw new ArgumentNullException("availableMargin", "availableMargin is a required property for CrossexAccount and cannot be null");
            // to ensure "marginBalance" is required (not null)
            this.MarginBalance = marginBalance ?? throw new ArgumentNullException("marginBalance", "marginBalance is a required property for CrossexAccount and cannot be null");
            // to ensure "initialMargin" is required (not null)
            this.InitialMargin = initialMargin ?? throw new ArgumentNullException("initialMargin", "initialMargin is a required property for CrossexAccount and cannot be null");
            // to ensure "maintenanceMargin" is required (not null)
            this.MaintenanceMargin = maintenanceMargin ?? throw new ArgumentNullException("maintenanceMargin", "maintenanceMargin is a required property for CrossexAccount and cannot be null");
            // to ensure "initialMarginRate" is required (not null)
            this.InitialMarginRate = initialMarginRate ?? throw new ArgumentNullException("initialMarginRate", "initialMarginRate is a required property for CrossexAccount and cannot be null");
            // to ensure "maintenanceMarginRate" is required (not null)
            this.MaintenanceMarginRate = maintenanceMarginRate ?? throw new ArgumentNullException("maintenanceMarginRate", "maintenanceMarginRate is a required property for CrossexAccount and cannot be null");
            // to ensure "positionMode" is required (not null)
            this.PositionMode = positionMode ?? throw new ArgumentNullException("positionMode", "positionMode is a required property for CrossexAccount and cannot be null");
            // to ensure "createTime" is required (not null)
            this.CreateTime = createTime ?? throw new ArgumentNullException("createTime", "createTime is a required property for CrossexAccount and cannot be null");
            // to ensure "updateTime" is required (not null)
            this.UpdateTime = updateTime ?? throw new ArgumentNullException("updateTime", "updateTime is a required property for CrossexAccount and cannot be null");
            // to ensure "assets" is required (not null)
            this.Assets = assets ?? throw new ArgumentNullException("assets", "assets is a required property for CrossexAccount and cannot be null");
        ...
        {
            return this.Equals(input as CrossexAccount);
        }

        /// <summary>
        /// Returns true if CrossexAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of CrossexAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrossexAccount input)
        {
            if (input == null)
                return false;
