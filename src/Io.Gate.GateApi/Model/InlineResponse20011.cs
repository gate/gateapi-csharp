...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse20011 :  IEquatable<InlineResponse20011>, IValidatableObject
    {
        ...
        public InlineResponse20011(decimal timestamp = default(decimal), string method = default(string), int code = default(int), string message = default(string), List<InlineResponse20011Data> data = default(List<InlineResponse20011Data>), string version = default(string))
        {
            this.Timestamp = timestamp;
            // to ensure "method" is required (not null)
            this.Method = method ?? throw new ArgumentNullException("method", "method is a required property for InlineResponse20011 and cannot be null");
            this.Code = code;
            ...
            this.Version = version ?? throw new ArgumentNullException("version", "version is a required property for InlineResponse20011 and cannot be null");
        }
