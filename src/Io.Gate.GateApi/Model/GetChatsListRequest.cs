...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetChatsListRequest :  IEquatable<GetChatsListRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GetChatsListRequest);
        }

        /// <summary>
        /// Returns true if GetChatsListRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetChatsListRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetChatsListRequest input)
        {
            if (input == null)
                return false;
