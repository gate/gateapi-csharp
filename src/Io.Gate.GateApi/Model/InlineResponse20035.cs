...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse20035 :  IEquatable<InlineResponse20035>, IValidatableObject
    {
        ...
        public InlineResponse20035(string userId = default(string), string availableMargin = default(string), string marginBalance = default(string), string initialMargin = default(string), string maintenanceMargin = default(string), string initialMarginRate = default(string), string maintenanceMarginRate = default(string), string positionMode = default(string), string accountLimit = default(string), string createTime = default(string), string updateTime = default(string), string accountMode = default(string), string exchangeType = default(string), List<InlineResponse20035Assets> assets = default(List<InlineResponse20035Assets>))
        {
            ...
            this.AvailableMargin = availableMargin ?? throw new ArgumentNullException("availableMargin", "availableMargin is a required property for InlineResponse20035 and cannot be null");
            // to ensure "marginBalance" is required (not null)
            this.MarginBalance = marginBalance ?? throw new ArgumentNullException("marginBalance", "marginBalance is a required property for InlineResponse20035 and cannot be null");
            // to ensure "initialMargin" is required (not null)
            this.InitialMargin = initialMargin ?? throw new ArgumentNullException("initialMargin", "initialMargin is a required property for InlineResponse20035 and cannot be null");
            // to ensure "maintenanceMargin" is required (not null)
            this.MaintenanceMargin = maintenanceMargin ?? throw new ArgumentNullException("maintenanceMargin", "maintenanceMargin is a required property for InlineResponse20035 and cannot be null");
            // to ensure "initialMarginRate" is required (not null)
            this.InitialMarginRate = initialMarginRate ?? throw new ArgumentNullException("initialMarginRate", "initialMarginRate is a required property for InlineResponse20035 and cannot be null");
            // to ensure "maintenanceMarginRate" is required (not null)
            this.MaintenanceMarginRate = maintenanceMarginRate ?? throw new ArgumentNullException("maintenanceMarginRate", "maintenanceMarginRate is a required property for InlineResponse20035 and cannot be null");
            // to ensure "positionMode" is required (not null)
            this.PositionMode = positionMode ?? throw new ArgumentNullException("positionMode", "positionMode is a required property for InlineResponse20035 and cannot be null");
            ...
            this.Assets = assets ?? throw new ArgumentNullException("assets", "assets is a required property for InlineResponse20035 and cannot be null");
        ...
        public List<InlineResponse20035Assets> Assets { get; set; }
