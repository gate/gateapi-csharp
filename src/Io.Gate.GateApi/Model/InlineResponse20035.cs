...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse20035 :  IEquatable<InlineResponse20035>, IValidatableObject
    {
        ...
        public InlineResponse20035(string userId = default(string), string orderId = default(string), string text = default(string), string state = default(string), string symbol = default(string), string attribute = default(string), string exchangeType = default(string), string businessType = default(string), string qty = default(string), string quoteQty = default(string), string price = default(string), string timeInForce = default(string), string executedQty = default(string), string executedAmount = default(string), string executedAvgPrice = default(string), string feeCoin = default(string), string fee = default(string), string reduceOnly = default(string), string leverage = default(string), string reason = default(string), string lastExecutedQty = default(string), string lastExecutedPrice = default(string), string lastExecutedAmount = default(string), string positionSide = default(string), string createTime = default(string), string updateTime = default(string))
        {
            // to ensure "userId" is required (not null)
            this.UserId = userId ?? throw new ArgumentNullException("userId", "userId is a required property for InlineResponse20035 and cannot be null");
            // to ensure "orderId" is required (not null)
            this.OrderId = orderId ?? throw new ArgumentNullException("orderId", "orderId is a required property for InlineResponse20035 and cannot be null");
            // to ensure "text" is required (not null)
            this.Text = text ?? throw new ArgumentNullException("text", "text is a required property for InlineResponse20035 and cannot be null");
            // to ensure "state" is required (not null)
            this.State = state ?? throw new ArgumentNullException("state", "state is a required property for InlineResponse20035 and cannot be null");
            ...
            this.Attribute = attribute ?? throw new ArgumentNullException("attribute", "attribute is a required property for InlineResponse20035 and cannot be null");
            ...
            this.BusinessType = businessType ?? throw new ArgumentNullException("businessType", "businessType is a required property for InlineResponse20035 and cannot be null");
            // to ensure "qty" is required (not null)
            this.Qty = qty ?? throw new ArgumentNullException("qty", "qty is a required property for InlineResponse20035 and cannot be null");
            // to ensure "quoteQty" is required (not null)
            this.QuoteQty = quoteQty ?? throw new ArgumentNullException("quoteQty", "quoteQty is a required property for InlineResponse20035 and cannot be null");
            // to ensure "price" is required (not null)
            this.Price = price ?? throw new ArgumentNullException("price", "price is a required property for InlineResponse20035 and cannot be null");
            // to ensure "timeInForce" is required (not null)
            this.TimeInForce = timeInForce ?? throw new ArgumentNullException("timeInForce", "timeInForce is a required property for InlineResponse20035 and cannot be null");
            // to ensure "executedQty" is required (not null)
            this.ExecutedQty = executedQty ?? throw new ArgumentNullException("executedQty", "executedQty is a required property for InlineResponse20035 and cannot be null");
            // to ensure "executedAmount" is required (not null)
            this.ExecutedAmount = executedAmount ?? throw new ArgumentNullException("executedAmount", "executedAmount is a required property for InlineResponse20035 and cannot be null");
            // to ensure "executedAvgPrice" is required (not null)
            this.ExecutedAvgPrice = executedAvgPrice ?? throw new ArgumentNullException("executedAvgPrice", "executedAvgPrice is a required property for InlineResponse20035 and cannot be null");
            // to ensure "feeCoin" is required (not null)
            this.FeeCoin = feeCoin ?? throw new ArgumentNullException("feeCoin", "feeCoin is a required property for InlineResponse20035 and cannot be null");
            // to ensure "fee" is required (not null)
            this.Fee = fee ?? throw new ArgumentNullException("fee", "fee is a required property for InlineResponse20035 and cannot be null");
            // to ensure "reduceOnly" is required (not null)
            this.ReduceOnly = reduceOnly ?? throw new ArgumentNullException("reduceOnly", "reduceOnly is a required property for InlineResponse20035 and cannot be null");
            ...
            this.Reason = reason ?? throw new ArgumentNullException("reason", "reason is a required property for InlineResponse20035 and cannot be null");
            // to ensure "lastExecutedQty" is required (not null)
            this.LastExecutedQty = lastExecutedQty ?? throw new ArgumentNullException("lastExecutedQty", "lastExecutedQty is a required property for InlineResponse20035 and cannot be null");
            // to ensure "lastExecutedPrice" is required (not null)
            this.LastExecutedPrice = lastExecutedPrice ?? throw new ArgumentNullException("lastExecutedPrice", "lastExecutedPrice is a required property for InlineResponse20035 and cannot be null");
            // to ensure "lastExecutedAmount" is required (not null)
            this.LastExecutedAmount = lastExecutedAmount ?? throw new ArgumentNullException("lastExecutedAmount", "lastExecutedAmount is a required property for InlineResponse20035 and cannot be null");
            // to ensure "positionSide" is required (not null)
            this.PositionSide = positionSide ?? throw new ArgumentNullException("positionSide", "positionSide is a required property for InlineResponse20035 and cannot be null");
            // to ensure "createTime" is required (not null)
            this.CreateTime = createTime ?? throw new ArgumentNullException("createTime", "createTime is a required property for InlineResponse20035 and cannot be null");
            // to ensure "updateTime" is required (not null)
            this.UpdateTime = updateTime ?? throw new ArgumentNullException("updateTime", "updateTime is a required property for InlineResponse20035 and cannot be null");
        }
