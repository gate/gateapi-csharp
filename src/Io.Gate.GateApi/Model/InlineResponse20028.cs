...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse20028 :  IEquatable<InlineResponse20028>, IValidatableObject
    {
        ...
        public InlineResponse20028(string coin = default(string), decimal minTransAmount = default(decimal), decimal estFee = default(decimal), int precision = default(int), int isDisabled = default(int))
        {
