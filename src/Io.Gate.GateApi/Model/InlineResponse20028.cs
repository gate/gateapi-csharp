...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse20028 :  IEquatable<InlineResponse20028>, IValidatableObject
    {
        ...
        public InlineResponse20028(string id = default(string), string text = default(string), string fromAccountType = default(string), string toAccountType = default(string), string coin = default(string), string amount = default(string), string actualReceive = default(string), string status = default(string), string failReason = default(string), int createTime = default(int), int updateTime = default(int))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id", "id is a required property for InlineResponse20028 and cannot be null");
            ...
            this.FromAccountType = fromAccountType ?? throw new ArgumentNullException("fromAccountType", "fromAccountType is a required property for InlineResponse20028 and cannot be null");
            // to ensure "toAccountType" is required (not null)
            this.ToAccountType = toAccountType ?? throw new ArgumentNullException("toAccountType", "toAccountType is a required property for InlineResponse20028 and cannot be null");
            // to ensure "coin" is required (not null)
            this.Coin = coin ?? throw new ArgumentNullException("coin", "coin is a required property for InlineResponse20028 and cannot be null");
            // to ensure "amount" is required (not null)
            this.Amount = amount ?? throw new ArgumentNullException("amount", "amount is a required property for InlineResponse20028 and cannot be null");
            // to ensure "status" is required (not null)
            this.Status = status ?? throw new ArgumentNullException("status", "status is a required property for InlineResponse20028 and cannot be null");
