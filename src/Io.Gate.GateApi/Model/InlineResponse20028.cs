...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse20028 :  IEquatable<InlineResponse20028>, IValidatableObject
    {
        ...
        public InlineResponse20028(string txId = default(string), string text = default(string))
        {
            // to ensure "txId" is required (not null)
            this.TxId = txId ?? throw new ArgumentNullException("txId", "txId is a required property for InlineResponse20028 and cannot be null");
