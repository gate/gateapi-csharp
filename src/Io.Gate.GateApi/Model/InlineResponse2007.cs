...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse2007 :  IEquatable<InlineResponse2007>, IValidatableObject
    {
        ...
        public InlineResponse2007(int code = default(int), string message = default(string), InlineResponse2007Data data = default(InlineResponse2007Data))
        {
            this.Code = code;
            ...
            this.Data = data ?? throw new ArgumentNullException("data", "data is a required property for InlineResponse2007 and cannot be null");
        }
