...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse20015Data :  IEquatable<InlineResponse20015Data>, IValidatableObject
    {
        ...
        public InlineResponse20015Data(string rate = default(string), string type = default(string), string amount = default(string), string minAmount = default(string), string maxAmount = default(string), string total = default(string), int payAli = default(int), int payBank = default(int), int payPaypal = default(int), int payWechat = default(int), string payTypeNum = default(string), string payTypeJson = default(string), string lockedAmount = default(string), int orderid = default(int), int timestamp = default(int), string currencyType = default(string), string wantType = default(string), string hideRate = default(string), string tradeTips = default(string), string autoReply = default(string), string newHand = default(string), int rateRefId = default(int), decimal rateOffset = default(decimal), string status = default(string), int rateFixed = default(int), int floatTrend = default(int), int expireMin = default(int), int tierLimit = default(int), int regTimeLimit = default(int), int advertisersLimit = default(int), int verifiedLimit = default(int), int minCompletedLimit = default(int), int maxCompletedLimit = default(int), int userOrdersLimit = default(int), int completedRateLimit = default(int), int userCountryLimit = default(int), string limitCountryCn = default(string), string limitCountryEn = default(string), int isHedge = default(int), int hidePayment = default(int), int fee = default(int))
        {
            // to ensure "rate" is required (not null)
            this.Rate = rate ?? throw new ArgumentNullException("rate", "rate is a required property for InlineResponse20015Data and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type", "type is a required property for InlineResponse20015Data and cannot be null");
            // to ensure "amount" is required (not null)
            this.Amount = amount ?? throw new ArgumentNullException("amount", "amount is a required property for InlineResponse20015Data and cannot be null");
            // to ensure "minAmount" is required (not null)
            this.MinAmount = minAmount ?? throw new ArgumentNullException("minAmount", "minAmount is a required property for InlineResponse20015Data and cannot be null");
            // to ensure "maxAmount" is required (not null)
            this.MaxAmount = maxAmount ?? throw new ArgumentNullException("maxAmount", "maxAmount is a required property for InlineResponse20015Data and cannot be null");
            // to ensure "total" is required (not null)
            this.Total = total ?? throw new ArgumentNullException("total", "total is a required property for InlineResponse20015Data and cannot be null");
            this.PayAli = payAli;
            this.PayBank = payBank;
            this.PayPaypal = payPaypal;
            this.PayWechat = payWechat;
            // to ensure "payTypeNum" is required (not null)
            this.PayTypeNum = payTypeNum ?? throw new ArgumentNullException("payTypeNum", "payTypeNum is a required property for InlineResponse20015Data and cannot be null");
            // to ensure "payTypeJson" is required (not null)
            this.PayTypeJson = payTypeJson ?? throw new ArgumentNullException("payTypeJson", "payTypeJson is a required property for InlineResponse20015Data and cannot be null");
            // to ensure "lockedAmount" is required (not null)
            this.LockedAmount = lockedAmount ?? throw new ArgumentNullException("lockedAmount", "lockedAmount is a required property for InlineResponse20015Data and cannot be null");
            this.Orderid = orderid;
            this.Timestamp = timestamp;
            // to ensure "currencyType" is required (not null)
            this.CurrencyType = currencyType ?? throw new ArgumentNullException("currencyType", "currencyType is a required property for InlineResponse20015Data and cannot be null");
            // to ensure "wantType" is required (not null)
            this.WantType = wantType ?? throw new ArgumentNullException("wantType", "wantType is a required property for InlineResponse20015Data and cannot be null");
            // to ensure "hideRate" is required (not null)
            this.HideRate = hideRate ?? throw new ArgumentNullException("hideRate", "hideRate is a required property for InlineResponse20015Data and cannot be null");
            // to ensure "tradeTips" is required (not null)
            this.TradeTips = tradeTips ?? throw new ArgumentNullException("tradeTips", "tradeTips is a required property for InlineResponse20015Data and cannot be null");
            // to ensure "autoReply" is required (not null)
            this.AutoReply = autoReply ?? throw new ArgumentNullException("autoReply", "autoReply is a required property for InlineResponse20015Data and cannot be null");
            // to ensure "newHand" is required (not null)
            this.NewHand = newHand ?? throw new ArgumentNullException("newHand", "newHand is a required property for InlineResponse20015Data and cannot be null");
            this.RateRefId = rateRefId;
            this.RateOffset = rateOffset;
            // to ensure "status" is required (not null)
            this.Status = status ?? throw new ArgumentNullException("status", "status is a required property for InlineResponse20015Data and cannot be null");
            ...
            this.LimitCountryCn = limitCountryCn ?? throw new ArgumentNullException("limitCountryCn", "limitCountryCn is a required property for InlineResponse20015Data and cannot be null");
            // to ensure "limitCountryEn" is required (not null)
            this.LimitCountryEn = limitCountryEn ?? throw new ArgumentNullException("limitCountryEn", "limitCountryEn is a required property for InlineResponse20015Data and cannot be null");
