...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class ApiResponseExSkillClaimRewardResp :  IEquatable<ApiResponseExSkillClaimRewardResp>, IValidatableObject
    {
        ...
        public ApiResponseExSkillClaimRewardResp(int code = default(int), string label = default(string), string message = default(string), ApiResponseExSkillClaimRewardRespData data = default(ApiResponseExSkillClaimRewardRespData), long timestamp = default(long))
        {
            this.Code = code;
            this.Label = label;
        ...
        public ApiResponseExSkillClaimRewardRespData Data { get; set; }
        ...
        {
            return this.Equals(input as ApiResponseExSkillClaimRewardResp);
        }

        /// <summary>
        /// Returns true if ApiResponseExSkillClaimRewardResp instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseExSkillClaimRewardResp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseExSkillClaimRewardResp input)
        {
            if (input == null)
                return false;
