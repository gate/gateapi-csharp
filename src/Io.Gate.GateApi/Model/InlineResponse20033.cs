...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse20033 :  IEquatable<InlineResponse20033>, IValidatableObject
    {
        ...
        public InlineResponse20033(decimal orderId = default(decimal), string text = default(string))
        {
            this.OrderId = orderId;
            // to ensure "text" is required (not null)
            this.Text = text ?? throw new ArgumentNullException("text", "text is a required property for InlineResponse20033 and cannot be null");
        }
