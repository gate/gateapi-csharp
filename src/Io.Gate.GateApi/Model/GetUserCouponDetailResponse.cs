...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetUserCouponDetailResponse :  IEquatable<GetUserCouponDetailResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetUserCouponDetailResponse" /> class.
        /// </summary>
        ...
        public GetUserCouponDetailResponse(CodeEnum? code = default(CodeEnum?), string label = default(string), string message = default(string), GetUserCouponDetailResponseData data = default(GetUserCouponDetailResponseData))
        {
            this.Code = code;
            this.Label = label;
        ...
        public GetUserCouponDetailResponseData Data { get; set; }
        ...
        {
            return this.Equals(input as GetUserCouponDetailResponse);
        }

        /// <summary>
        /// Returns true if GetUserCouponDetailResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetUserCouponDetailResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetUserCouponDetailResponse input)
        {
            if (input == null)
                return false;
