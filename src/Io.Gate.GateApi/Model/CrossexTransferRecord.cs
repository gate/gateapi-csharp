...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CrossexTransferRecord :  IEquatable<CrossexTransferRecord>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrossexTransferRecord" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CrossexTransferRecord() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CrossexTransferRecord" /> class.
        /// </summary>
        /// <param name="id">Order ID (required).</param>
        /// <param name="text">Client Custom ID (required).</param>
        /// <param name="fromAccountType">&#x60;from&#x60; credit account touched by this operation (&#x60;CROSSEX_BINANCE&#x60;, &#x60;CROSSEX_OKX&#x60;, &#x60;CROSSEX_GATE&#x60;, &#x60;CROSSEX_BYBIT&#x60;, &#x60;CROSSEX_KRAKEN&#x60;, &#x60;CROSSEX_HYPERLIQUID&#x60;, &#x60;CROSSEX_DERIBIT&#x60;, &#x60;CROSSEX&#x60;, &#x60;SPOT&#x60;). (required).</param>
        /// <param name="toAccountType">&#x60;to&#x60; debit account handled by this operation (&#x60;CROSSEX_BINANCE&#x60;, &#x60;CROSSEX_OKX&#x60;, &#x60;CROSSEX_GATE&#x60;, &#x60;CROSSEX_BYBIT&#x60;, &#x60;CROSSEX_KRAKEN&#x60;, &#x60;CROSSEX_HYPERLIQUID&#x60;, &#x60;CROSSEX_DERIBIT&#x60;, &#x60;CROSSEX&#x60;, &#x60;SPOT&#x60;). (required).</param>
        ...
        public CrossexTransferRecord(string id = default(string), string text = default(string), string fromAccountType = default(string), string toAccountType = default(string), string coin = default(string), string amount = default(string), string actualReceive = default(string), string status = default(string), string failReason = default(string), int createTime = default(int), int updateTime = default(int))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id", "id is a required property for CrossexTransferRecord and cannot be null");
            // to ensure "text" is required (not null)
            this.Text = text ?? throw new ArgumentNullException("text", "text is a required property for CrossexTransferRecord and cannot be null");
            // to ensure "fromAccountType" is required (not null)
            this.FromAccountType = fromAccountType ?? throw new ArgumentNullException("fromAccountType", "fromAccountType is a required property for CrossexTransferRecord and cannot be null");
            // to ensure "toAccountType" is required (not null)
            this.ToAccountType = toAccountType ?? throw new ArgumentNullException("toAccountType", "toAccountType is a required property for CrossexTransferRecord and cannot be null");
            // to ensure "coin" is required (not null)
            this.Coin = coin ?? throw new ArgumentNullException("coin", "coin is a required property for CrossexTransferRecord and cannot be null");
            // to ensure "amount" is required (not null)
            this.Amount = amount ?? throw new ArgumentNullException("amount", "amount is a required property for CrossexTransferRecord and cannot be null");
            // to ensure "status" is required (not null)
            this.Status = status ?? throw new ArgumentNullException("status", "status is a required property for CrossexTransferRecord and cannot be null");
        ...
        /// </summary>
        /// <value>&#x60;from&#x60; credit account touched by this operation (&#x60;CROSSEX_BINANCE&#x60;, &#x60;CROSSEX_OKX&#x60;, &#x60;CROSSEX_GATE&#x60;, &#x60;CROSSEX_BYBIT&#x60;, &#x60;CROSSEX_KRAKEN&#x60;, &#x60;CROSSEX_HYPERLIQUID&#x60;, &#x60;CROSSEX_DERIBIT&#x60;, &#x60;CROSSEX&#x60;, &#x60;SPOT&#x60;).</value>
        ...
        /// </summary>
        /// <value>&#x60;to&#x60; debit account handled by this operation (&#x60;CROSSEX_BINANCE&#x60;, &#x60;CROSSEX_OKX&#x60;, &#x60;CROSSEX_GATE&#x60;, &#x60;CROSSEX_BYBIT&#x60;, &#x60;CROSSEX_KRAKEN&#x60;, &#x60;CROSSEX_HYPERLIQUID&#x60;, &#x60;CROSSEX_DERIBIT&#x60;, &#x60;CROSSEX&#x60;, &#x60;SPOT&#x60;).</value>
        ...
        {
            return this.Equals(input as CrossexTransferRecord);
        }

        /// <summary>
        /// Returns true if CrossexTransferRecord instances are equal
        /// </summary>
        /// <param name="input">Instance of CrossexTransferRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrossexTransferRecord input)
        {
            if (input == null)
                return false;
