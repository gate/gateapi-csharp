...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BrokerCommissionItem :  IEquatable<BrokerCommissionItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BrokerCommissionItem" /> class.
        /// </summary>
        ...
        /// </summary>
        /// <value>Commission time (Unix timestamp in seconds)</value>
        ...
        /// </summary>
        /// <value>Alpha contract address</value>
        ...
        {
            return this.Equals(input as BrokerCommissionItem);
        }

        /// <summary>
        /// Returns true if BrokerCommissionItem instances are equal
        /// </summary>
        /// <param name="input">Instance of BrokerCommissionItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BrokerCommissionItem input)
        {
            if (input == null)
                return false;
