...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineObject14 :  IEquatable<InlineObject14>, IValidatableObject
    {
        ...
        public InlineObject14(string exchangeType = default(string), string fromCoin = default(string), string toCoin = default(string), string fromAmount = default(string))
        {
            // to ensure "exchangeType" is required (not null)
            this.ExchangeType = exchangeType ?? throw new ArgumentNullException("exchangeType", "exchangeType is a required property for InlineObject14 and cannot be null");
            // to ensure "fromCoin" is required (not null)
            this.FromCoin = fromCoin ?? throw new ArgumentNullException("fromCoin", "fromCoin is a required property for InlineObject14 and cannot be null");
            // to ensure "toCoin" is required (not null)
            this.ToCoin = toCoin ?? throw new ArgumentNullException("toCoin", "toCoin is a required property for InlineObject14 and cannot be null");
            // to ensure "fromAmount" is required (not null)
            this.FromAmount = fromAmount ?? throw new ArgumentNullException("fromAmount", "fromAmount is a required property for InlineObject14 and cannot be null");
        }
