...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class OptionsMMP :  IEquatable<OptionsMMP>, IValidatableObject
    {
        ...
        /// <param name="window">Time window (milliseconds), between 1-5000, 0 means disable MMP (required).</param>
        ...
        /// </summary>
        /// <value>Time window (milliseconds), between 1-5000, 0 means disable MMP</value>
