...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CrossexTrade :  IEquatable<CrossexTrade>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrossexTrade" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CrossexTrade);
        }

        /// <summary>
        /// Returns true if CrossexTrade instances are equal
        /// </summary>
        /// <param name="input">Instance of CrossexTrade to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrossexTrade input)
        {
            if (input == null)
                return false;
