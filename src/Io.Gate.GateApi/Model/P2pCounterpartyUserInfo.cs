...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class P2pCounterpartyUserInfo :  IEquatable<P2pCounterpartyUserInfo>, IValidatableObject
    {
        /// <summary>
        ...
        public P2pCounterpartyUserInfo(string userTimest = default(string), string emailVerified = default(string), string verified = default(string), string hasPhone = default(string), string userName = default(string), string userNote = default(string), string completeTransactions = default(string), string paidTransactions = default(string), string acceptedTransactions = default(string), string transactionsUsedTime = default(string), string cancelledUsedTimeMonth = default(string), string completeTransactionsMonth = default(string), decimal completeRateMonth = default(decimal), int isFollow = default(int), int haveTraded = default(int), string bizUid = default(string), int registrationDays = default(int), int firstTradeDays = default(int), bool tradeVersatile = default(bool))
        {
        ...
        {
            return this.Equals(input as P2pCounterpartyUserInfo);
        }

        /// <summary>
        /// Returns true if P2pCounterpartyUserInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of P2pCounterpartyUserInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(P2pCounterpartyUserInfo input)
        {
            if (input == null)
                return false;
