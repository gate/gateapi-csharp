...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineObject8 :  IEquatable<InlineObject8>, IValidatableObject
    {
        ...
        public InlineObject8(string type = default(string), string side = default(string), string cryptoCurrency = default(string), string fiatCurrency = default(string), string cryptoAmount = default(string), string fiatAmount = default(string), string promotionCode = default(string), string quoteToken = default(string), string bankId = default(string))
        {
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type", "type is a required property for InlineObject8 and cannot be null");
            // to ensure "side" is required (not null)
            this.Side = side ?? throw new ArgumentNullException("side", "side is a required property for InlineObject8 and cannot be null");
            ...
            this.CryptoAmount = cryptoAmount ?? throw new ArgumentNullException("cryptoAmount", "cryptoAmount is a required property for InlineObject8 and cannot be null");
            // to ensure "fiatAmount" is required (not null)
            this.FiatAmount = fiatAmount ?? throw new ArgumentNullException("fiatAmount", "fiatAmount is a required property for InlineObject8 and cannot be null");
            // to ensure "quoteToken" is required (not null)
            this.QuoteToken = quoteToken ?? throw new ArgumentNullException("quoteToken", "quoteToken is a required property for InlineObject8 and cannot be null");
            // to ensure "bankId" is required (not null)
            this.BankId = bankId ?? throw new ArgumentNullException("bankId", "bankId is a required property for InlineObject8 and cannot be null");
