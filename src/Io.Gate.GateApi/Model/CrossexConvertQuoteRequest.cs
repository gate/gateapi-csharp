...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CrossexConvertQuoteRequest :  IEquatable<CrossexConvertQuoteRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrossexConvertQuoteRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CrossexConvertQuoteRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CrossexConvertQuoteRequest" /> class.
        /// </summary>
        ...
        public CrossexConvertQuoteRequest(string exchangeType = default(string), string fromCoin = default(string), string toCoin = default(string), string fromAmount = default(string))
        {
            // to ensure "exchangeType" is required (not null)
            this.ExchangeType = exchangeType ?? throw new ArgumentNullException("exchangeType", "exchangeType is a required property for CrossexConvertQuoteRequest and cannot be null");
            // to ensure "fromCoin" is required (not null)
            this.FromCoin = fromCoin ?? throw new ArgumentNullException("fromCoin", "fromCoin is a required property for CrossexConvertQuoteRequest and cannot be null");
            // to ensure "toCoin" is required (not null)
            this.ToCoin = toCoin ?? throw new ArgumentNullException("toCoin", "toCoin is a required property for CrossexConvertQuoteRequest and cannot be null");
            // to ensure "fromAmount" is required (not null)
            this.FromAmount = fromAmount ?? throw new ArgumentNullException("fromAmount", "fromAmount is a required property for CrossexConvertQuoteRequest and cannot be null");
        }
        ...
        {
            return this.Equals(input as CrossexConvertQuoteRequest);
        }

        /// <summary>
        /// Returns true if CrossexConvertQuoteRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CrossexConvertQuoteRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrossexConvertQuoteRequest input)
        {
            if (input == null)
                return false;
