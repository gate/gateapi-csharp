...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeliveryLiquidate :  IEquatable<DeliveryLiquidate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeliveryLiquidate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public DeliveryLiquidate()
        {
        }
        ...
        {
            return this.Equals(input as DeliveryLiquidate);
        }

        /// <summary>
        /// Returns true if DeliveryLiquidate instances are equal
        /// </summary>
        /// <param name="input">Instance of DeliveryLiquidate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeliveryLiquidate input)
        {
            if (input == null)
                return false;
