...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class FuturesUpdatePriceTriggeredOrder :  IEquatable<FuturesUpdatePriceTriggeredOrder>, IValidatableObject
    {
        ...
        /// <param name="autoSize">单仓模式不需设置auto_size 双仓模式部分平仓(size≠0)时，不需设置auto_size 双仓模式全部平仓(size&#x3D;0)时，必须设置auto_size，close_long 平多头， close_short 平空头.</param>
        ...
        /// </summary>
        /// <value>单仓模式不需设置auto_size 双仓模式部分平仓(size≠0)时，不需设置auto_size 双仓模式全部平仓(size&#x3D;0)时，必须设置auto_size，close_long 平多头， close_short 平空头</value>
