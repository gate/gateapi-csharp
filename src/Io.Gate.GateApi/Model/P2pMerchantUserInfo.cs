...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class P2pMerchantUserInfo :  IEquatable<P2pMerchantUserInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="P2pMerchantUserInfo" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as P2pMerchantUserInfo);
        }

        /// <summary>
        /// Returns true if P2pMerchantUserInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of P2pMerchantUserInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(P2pMerchantUserInfo input)
        {
            if (input == null)
                return false;
