...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OtcOrderRequest :  IEquatable<OtcOrderRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OtcOrderRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OtcOrderRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OtcOrderRequest" /> class.
        /// </summary>
        ...
        public OtcOrderRequest(string type = default(string), string side = default(string), string cryptoCurrency = default(string), string fiatCurrency = default(string), string cryptoAmount = default(string), string fiatAmount = default(string), string promotionCode = default(string), string quoteToken = default(string), string bankId = default(string))
        {
            ...
            this.Type = type ?? throw new ArgumentNullException("type", "type is a required property for OtcOrderRequest and cannot be null");
            // to ensure "side" is required (not null)
            this.Side = side ?? throw new ArgumentNullException("side", "side is a required property for OtcOrderRequest and cannot be null");
            // to ensure "cryptoCurrency" is required (not null)
            this.CryptoCurrency = cryptoCurrency ?? throw new ArgumentNullException("cryptoCurrency", "cryptoCurrency is a required property for OtcOrderRequest and cannot be null");
            // to ensure "fiatCurrency" is required (not null)
            this.FiatCurrency = fiatCurrency ?? throw new ArgumentNullException("fiatCurrency", "fiatCurrency is a required property for OtcOrderRequest and cannot be null");
            // to ensure "cryptoAmount" is required (not null)
            this.CryptoAmount = cryptoAmount ?? throw new ArgumentNullException("cryptoAmount", "cryptoAmount is a required property for OtcOrderRequest and cannot be null");
            // to ensure "fiatAmount" is required (not null)
            this.FiatAmount = fiatAmount ?? throw new ArgumentNullException("fiatAmount", "fiatAmount is a required property for OtcOrderRequest and cannot be null");
            // to ensure "quoteToken" is required (not null)
            this.QuoteToken = quoteToken ?? throw new ArgumentNullException("quoteToken", "quoteToken is a required property for OtcOrderRequest and cannot be null");
            // to ensure "bankId" is required (not null)
            this.BankId = bankId ?? throw new ArgumentNullException("bankId", "bankId is a required property for OtcOrderRequest and cannot be null");
        ...
        {
            return this.Equals(input as OtcOrderRequest);
        }

        /// <summary>
        /// Returns true if OtcOrderRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of OtcOrderRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OtcOrderRequest input)
        {
            if (input == null)
                return false;
