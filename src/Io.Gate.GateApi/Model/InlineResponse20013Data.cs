...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse20013Data :  IEquatable<InlineResponse20013Data>, IValidatableObject
    {
        ...
        public InlineResponse20013Data(List<InlineResponse20013DataList> list = default(List<InlineResponse20013DataList>), int page = default(int), int pageSize = default(int), int pageCount = default(int), int totalCount = default(int), string url = default(string))
        {
            // to ensure "list" is required (not null)
            this.List = list ?? throw new ArgumentNullException("list", "list is a required property for InlineResponse20013Data and cannot be null");
            this.Page = page;
            this.PageSize = pageSize;
            this.PageCount = pageCount;
            this.TotalCount = totalCount;
            // to ensure "url" is required (not null)
            this.Url = url ?? throw new ArgumentNullException("url", "url is a required property for InlineResponse20013Data and cannot be null");
        }
        ...
        public List<InlineResponse20013DataList> List { get; set; }
