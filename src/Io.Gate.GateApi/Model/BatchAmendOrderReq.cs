...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class BatchAmendOrderReq :  IEquatable<BatchAmendOrderReq>, IValidatableObject
    {
        ...
        public BatchAmendOrderReq(long orderId = default(long), string text = default(string), string size = default(string), string price = default(string), string amendText = default(string), string actionMode = default(string))
        {
