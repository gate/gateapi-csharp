...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ListActivitiesResponseDataList :  IEquatable<ListActivitiesResponseDataList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListActivitiesResponseDataList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListActivitiesResponseDataList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListActivitiesResponseDataList" /> class.
        /// </summary>
        ...
        public ListActivitiesResponseDataList(int id = default(int), int typeId = default(int), string typeName = default(string), string competitionName = default(string), int startAt = default(int), int endAt = default(int), string img = default(string), string imgDark = default(string), string url = default(string), int hot = default(int), string masterOneLine = default(string), string masterTwoLine = default(string), string slaveOneLine = default(string), string slaveTwoLine = default(string), string competitionTitle = default(string), int topId = default(int), int parentId = default(int), string newImg = default(string), string newImgDark = default(string), List<string> tag = default(List<string>))
        {
            this.Id = id;
            this.TypeId = typeId;
            // to ensure "typeName" is required (not null)
            this.TypeName = typeName ?? throw new ArgumentNullException("typeName", "typeName is a required property for ListActivitiesResponseDataList and cannot be null");
            // to ensure "competitionName" is required (not null)
            this.CompetitionName = competitionName ?? throw new ArgumentNullException("competitionName", "competitionName is a required property for ListActivitiesResponseDataList and cannot be null");
            this.StartAt = startAt;
            this.EndAt = endAt;
            // to ensure "img" is required (not null)
            this.Img = img ?? throw new ArgumentNullException("img", "img is a required property for ListActivitiesResponseDataList and cannot be null");
            // to ensure "imgDark" is required (not null)
            this.ImgDark = imgDark ?? throw new ArgumentNullException("imgDark", "imgDark is a required property for ListActivitiesResponseDataList and cannot be null");
            // to ensure "url" is required (not null)
            this.Url = url ?? throw new ArgumentNullException("url", "url is a required property for ListActivitiesResponseDataList and cannot be null");
            this.Hot = hot;
            // to ensure "masterOneLine" is required (not null)
            this.MasterOneLine = masterOneLine ?? throw new ArgumentNullException("masterOneLine", "masterOneLine is a required property for ListActivitiesResponseDataList and cannot be null");
            // to ensure "masterTwoLine" is required (not null)
            this.MasterTwoLine = masterTwoLine ?? throw new ArgumentNullException("masterTwoLine", "masterTwoLine is a required property for ListActivitiesResponseDataList and cannot be null");
            // to ensure "slaveOneLine" is required (not null)
            this.SlaveOneLine = slaveOneLine ?? throw new ArgumentNullException("slaveOneLine", "slaveOneLine is a required property for ListActivitiesResponseDataList and cannot be null");
            // to ensure "slaveTwoLine" is required (not null)
            this.SlaveTwoLine = slaveTwoLine ?? throw new ArgumentNullException("slaveTwoLine", "slaveTwoLine is a required property for ListActivitiesResponseDataList and cannot be null");
            // to ensure "competitionTitle" is required (not null)
            this.CompetitionTitle = competitionTitle ?? throw new ArgumentNullException("competitionTitle", "competitionTitle is a required property for ListActivitiesResponseDataList and cannot be null");
            this.TopId = topId;
            this.ParentId = parentId;
            // to ensure "newImg" is required (not null)
            this.NewImg = newImg ?? throw new ArgumentNullException("newImg", "newImg is a required property for ListActivitiesResponseDataList and cannot be null");
            // to ensure "newImgDark" is required (not null)
            this.NewImgDark = newImgDark ?? throw new ArgumentNullException("newImgDark", "newImgDark is a required property for ListActivitiesResponseDataList and cannot be null");
            // to ensure "tag" is required (not null)
            this.Tag = tag ?? throw new ArgumentNullException("tag", "tag is a required property for ListActivitiesResponseDataList and cannot be null");
        }
        ...
        {
            return this.Equals(input as ListActivitiesResponseDataList);
        }

        /// <summary>
        /// Returns true if ListActivitiesResponseDataList instances are equal
        /// </summary>
        /// <param name="input">Instance of ListActivitiesResponseDataList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListActivitiesResponseDataList input)
        {
            if (input == null)
                return false;
