...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class UnifiedSettings :  IEquatable<UnifiedSettings>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="usdtFutures">USDT futures switch. In cross-currency margin mode, can only be enabled and cannot be disabled.</param>
        /// <param name="spotHedge">Spot hedging switch.</param>
        /// <param name="useFunding">Earn switch, when mode is cross-currency margin mode, whether to use Earn funds as margin.</param>
        /// <param name="options">Options switch. In cross-currency margin mode, can only be enabled and cannot be disabled.</param>
        ...
        /// </summary>
        /// <value>USDT futures switch. In cross-currency margin mode, can only be enabled and cannot be disabled</value>
        ...
        /// </summary>
        /// <value>Earn switch, when mode is cross-currency margin mode, whether to use Earn funds as margin</value>
        ...
        /// </summary>
        /// <value>Options switch. In cross-currency margin mode, can only be enabled and cannot be disabled</value>
