...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class P2pMyAd :  IEquatable<P2pMyAd>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as P2pMyAd);
        }

        /// <summary>
        /// Returns true if P2pMyAd instances are equal
        /// </summary>
        /// <param name="input">Instance of P2pMyAd to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(P2pMyAd input)
        {
            if (input == null)
                return false;
