...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineObject15 :  IEquatable<InlineObject15>, IValidatableObject
    {
        ...
        public InlineObject15(string quoteId = default(string))
        {
            // to ensure "quoteId" is required (not null)
            this.QuoteId = quoteId ?? throw new ArgumentNullException("quoteId", "quoteId is a required property for InlineObject15 and cannot be null");
        }
