...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CrossexHistoricalMarginPosition :  IEquatable<CrossexHistoricalMarginPosition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrossexHistoricalMarginPosition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CrossexHistoricalMarginPosition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CrossexHistoricalMarginPosition" /> class.
        /// </summary>
        ...
        public CrossexHistoricalMarginPosition(string positionId = default(string), string userId = default(string), string symbol = default(string), string closedType = default(string), string closedPnl = default(string), string closedPnlRate = default(string), string openAvgPrice = default(string), string closedAvgPrice = default(string), string maxPositionQty = default(string), string closedQty = default(string), string closedValue = default(string), string liqFee = default(string), string positionSide = default(string), string leverage = default(string), string interest = default(string), string businessType = default(string), string createTime = default(string), string updateTime = default(string))
        {
            // to ensure "interest" is required (not null)
            this.Interest = interest ?? throw new ArgumentNullException("interest", "interest is a required property for CrossexHistoricalMarginPosition and cannot be null");
            // to ensure "businessType" is required (not null)
            this.BusinessType = businessType ?? throw new ArgumentNullException("businessType", "businessType is a required property for CrossexHistoricalMarginPosition and cannot be null");
        ...
        {
            return this.Equals(input as CrossexHistoricalMarginPosition);
        }

        /// <summary>
        /// Returns true if CrossexHistoricalMarginPosition instances are equal
        /// </summary>
        /// <param name="input">Instance of CrossexHistoricalMarginPosition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrossexHistoricalMarginPosition input)
        {
            if (input == null)
                return false;
