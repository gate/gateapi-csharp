...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class UnifiedPortfolioOutput :  IEquatable<UnifiedPortfolioOutput>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="maintainMarginTotal">Total maintenance margin, including only portfolio margin calculation results for positions in risk units, excluding borrowing margin. If borrowing exists, conventional borrowing margin requirements will still apply.</param>
        ...
        /// <param name="calculateTime">Calculation time.</param>
        ...
        /// </summary>
        /// <value>Total maintenance margin, including only portfolio margin calculation results for positions in risk units, excluding borrowing margin. If borrowing exists, conventional borrowing margin requirements will still apply</value>
