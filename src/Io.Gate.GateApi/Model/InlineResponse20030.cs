...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse20030 :  IEquatable<InlineResponse20030>, IValidatableObject
    {
        ...
        public InlineResponse20030(string txId = default(string), string text = default(string))
        {
            // to ensure "txId" is required (not null)
            this.TxId = txId ?? throw new ArgumentNullException("txId", "txId is a required property for InlineResponse20030 and cannot be null");
