...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class GetPendingTransactionListRequest :  IEquatable<GetPendingTransactionListRequest>, IValidatableObject
    {
        ...
        protected GetPendingTransactionListRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPendingTransactionListRequest" /> class.
        /// </summary>
        ...
        public GetPendingTransactionListRequest(string cryptoCurrency = default(string), string fiatCurrency = default(string), string orderTab = default(string), string selectType = default(string), string status = default(string), int txid = default(int), int startTime = default(int), int endTime = default(int))
        {
            ...
            this.FiatCurrency = fiatCurrency ?? throw new ArgumentNullException("fiatCurrency", "fiatCurrency is a required property for GetPendingTransactionListRequest and cannot be null");
        ...
        {
            return this.Equals(input as GetPendingTransactionListRequest);
        }

        /// <summary>
        /// Returns true if GetPendingTransactionListRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetPendingTransactionListRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetPendingTransactionListRequest input)
        {
            if (input == null)
                return false;
