...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FuturesLeverage :  IEquatable<FuturesLeverage>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as FuturesLeverage);
        }

        /// <summary>
        /// Returns true if FuturesLeverage instances are equal
        /// </summary>
        /// <param name="input">Instance of FuturesLeverage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FuturesLeverage input)
        {
            if (input == null)
                return false;
