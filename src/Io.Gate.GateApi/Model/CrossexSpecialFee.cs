...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CrossexSpecialFee :  IEquatable<CrossexSpecialFee>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrossexSpecialFee" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CrossexSpecialFee() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CrossexSpecialFee" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CrossexSpecialFee);
        }

        /// <summary>
        /// Returns true if CrossexSpecialFee instances are equal
        /// </summary>
        /// <param name="input">Instance of CrossexSpecialFee to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrossexSpecialFee input)
        {
            if (input == null)
                return false;
