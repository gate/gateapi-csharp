...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class TradFiClosePositionRequest :  IEquatable<TradFiClosePositionRequest>, IValidatableObject
    {
        ...
        protected TradFiClosePositionRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TradFiClosePositionRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TradFiClosePositionRequest);
        }

        /// <summary>
        /// Returns true if TradFiClosePositionRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TradFiClosePositionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TradFiClosePositionRequest input)
        {
            if (input == null)
                return false;
