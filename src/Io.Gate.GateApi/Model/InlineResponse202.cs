...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse202 :  IEquatable<InlineResponse202>, IValidatableObject
    {
        ...
        /// <param name="exchangeType">Requested exchange to modify (BINANCE/OKX/GATE/CROSSEX; when account mode is ISOLATED_EXCHANGE, the exchange must be specified to modify futures position mode).</param>
        public InlineResponse202(string positionMode = default(string), string accountMode = default(string), string exchangeType = default(string))
        {
        ...
        /// </summary>
        /// <value>Requested exchange to modify (BINANCE/OKX/GATE/CROSSEX; when account mode is ISOLATED_EXCHANGE, the exchange must be specified to modify futures position mode)</value>
