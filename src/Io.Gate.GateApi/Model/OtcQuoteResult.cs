...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OtcQuoteResult :  IEquatable<OtcQuoteResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OtcQuoteResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OtcQuoteResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OtcQuoteResult" /> class.
        /// </summary>
        ...
        public OtcQuoteResult(string type = default(string), string payCoin = default(string), string getCoin = default(string), string payAmount = default(string), string getAmount = default(string), string rate = default(string), string rateReci = default(string), string promotionCode = default(string), string side = default(string), string orderType = default(string), string quoteToken = default(string))
        {
            ...
            this.PayCoin = payCoin ?? throw new ArgumentNullException("payCoin", "payCoin is a required property for OtcQuoteResult and cannot be null");
            // to ensure "getCoin" is required (not null)
            this.GetCoin = getCoin ?? throw new ArgumentNullException("getCoin", "getCoin is a required property for OtcQuoteResult and cannot be null");
            // to ensure "payAmount" is required (not null)
            this.PayAmount = payAmount ?? throw new ArgumentNullException("payAmount", "payAmount is a required property for OtcQuoteResult and cannot be null");
            // to ensure "getAmount" is required (not null)
            this.GetAmount = getAmount ?? throw new ArgumentNullException("getAmount", "getAmount is a required property for OtcQuoteResult and cannot be null");
            // to ensure "rate" is required (not null)
            this.Rate = rate ?? throw new ArgumentNullException("rate", "rate is a required property for OtcQuoteResult and cannot be null");
            // to ensure "rateReci" is required (not null)
            this.RateReci = rateReci ?? throw new ArgumentNullException("rateReci", "rateReci is a required property for OtcQuoteResult and cannot be null");
            // to ensure "promotionCode" is required (not null)
            this.PromotionCode = promotionCode ?? throw new ArgumentNullException("promotionCode", "promotionCode is a required property for OtcQuoteResult and cannot be null");
            // to ensure "side" is required (not null)
            this.Side = side ?? throw new ArgumentNullException("side", "side is a required property for OtcQuoteResult and cannot be null");
        ...
        {
            return this.Equals(input as OtcQuoteResult);
        }

        /// <summary>
        /// Returns true if OtcQuoteResult instances are equal
        /// </summary>
        /// <param name="input">Instance of OtcQuoteResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OtcQuoteResult input)
        {
            if (input == null)
                return false;
