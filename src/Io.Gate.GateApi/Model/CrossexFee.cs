...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CrossexFee :  IEquatable<CrossexFee>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrossexFee" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CrossexFee() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CrossexFee" /> class.
        /// </summary>
        ...
        public CrossexFee(string spotMakerFee = default(string), string spotTakerFee = default(string), string futureMakerFee = default(string), string futureTakerFee = default(string), List<CrossexSpecialFee> specialFeeList = default(List<CrossexSpecialFee>))
        {
            // to ensure "spotMakerFee" is required (not null)
            this.SpotMakerFee = spotMakerFee ?? throw new ArgumentNullException("spotMakerFee", "spotMakerFee is a required property for CrossexFee and cannot be null");
            // to ensure "spotTakerFee" is required (not null)
            this.SpotTakerFee = spotTakerFee ?? throw new ArgumentNullException("spotTakerFee", "spotTakerFee is a required property for CrossexFee and cannot be null");
            // to ensure "futureMakerFee" is required (not null)
            this.FutureMakerFee = futureMakerFee ?? throw new ArgumentNullException("futureMakerFee", "futureMakerFee is a required property for CrossexFee and cannot be null");
            // to ensure "futureTakerFee" is required (not null)
            this.FutureTakerFee = futureTakerFee ?? throw new ArgumentNullException("futureTakerFee", "futureTakerFee is a required property for CrossexFee and cannot be null");
            // to ensure "specialFeeList" is required (not null)
            this.SpecialFeeList = specialFeeList ?? throw new ArgumentNullException("specialFeeList", "specialFeeList is a required property for CrossexFee and cannot be null");
        }
        ...
        {
            return this.Equals(input as CrossexFee);
        }

        /// <summary>
        /// Returns true if CrossexFee instances are equal
        /// </summary>
        /// <param name="input">Instance of CrossexFee to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrossexFee input)
        {
            if (input == null)
                return false;
