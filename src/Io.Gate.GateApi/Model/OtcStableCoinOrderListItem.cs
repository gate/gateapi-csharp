...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OtcStableCoinOrderListItem :  IEquatable<OtcStableCoinOrderListItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OtcStableCoinOrderListItem" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as OtcStableCoinOrderListItem);
        }

        /// <summary>
        /// Returns true if OtcStableCoinOrderListItem instances are equal
        /// </summary>
        /// <param name="input">Instance of OtcStableCoinOrderListItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OtcStableCoinOrderListItem input)
        {
            if (input == null)
                return false;
