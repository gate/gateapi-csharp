...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse20010DataList :  IEquatable<InlineResponse20010DataList>, IValidatableObject
    {
        ...
        public InlineResponse20010DataList(string time = default(string), int timestamp = default(int), string orderId = default(string), string tradeNo = default(string), string type = default(string), string status = default(string), string dbStatus = default(string), string fiatCurrency = default(string), InlineResponse20010DataFiatCurrencyInfo fiatCurrencyInfo = default(InlineResponse20010DataFiatCurrencyInfo), string fiatAmount = default(string), string cryptoCurrency = default(string), InlineResponse20010DataCryptoCurrencyInfo cryptoCurrencyInfo = default(InlineResponse20010DataCryptoCurrencyInfo), string cryptoAmount = default(string), string rate = default(string), string transferRemark = default(string), string gateBankAccountIban = default(string), string promotionCode = default(string))
        {
            this.Time = time;
        ...
        public InlineResponse20010DataFiatCurrencyInfo FiatCurrencyInfo { get; set; }
        ...
        public InlineResponse20010DataCryptoCurrencyInfo CryptoCurrencyInfo { get; set; }
