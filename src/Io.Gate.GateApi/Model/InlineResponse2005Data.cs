...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse2005Data :  IEquatable<InlineResponse2005Data>, IValidatableObject
    {
        ...
        protected InlineResponse2005Data() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2005Data" /> class.
        /// </summary>
        ...
        public InlineResponse2005Data(string id = default(string), string bankAccountName = default(string), string bankName = default(string), string bankCountry = default(string), string bankAddress = default(string), string bankCode = default(string), string branchCode = default(string))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id", "id is a required property for InlineResponse2005Data and cannot be null");
            // to ensure "bankAccountName" is required (not null)
            this.BankAccountName = bankAccountName ?? throw new ArgumentNullException("bankAccountName", "bankAccountName is a required property for InlineResponse2005Data and cannot be null");
            // to ensure "bankName" is required (not null)
            this.BankName = bankName ?? throw new ArgumentNullException("bankName", "bankName is a required property for InlineResponse2005Data and cannot be null");
            // to ensure "bankCountry" is required (not null)
            this.BankCountry = bankCountry ?? throw new ArgumentNullException("bankCountry", "bankCountry is a required property for InlineResponse2005Data and cannot be null");
            // to ensure "bankAddress" is required (not null)
            this.BankAddress = bankAddress ?? throw new ArgumentNullException("bankAddress", "bankAddress is a required property for InlineResponse2005Data and cannot be null");
            // to ensure "bankCode" is required (not null)
            this.BankCode = bankCode ?? throw new ArgumentNullException("bankCode", "bankCode is a required property for InlineResponse2005Data and cannot be null");
            // to ensure "branchCode" is required (not null)
            this.BranchCode = branchCode ?? throw new ArgumentNullException("branchCode", "branchCode is a required property for InlineResponse2005Data and cannot be null");
        }
