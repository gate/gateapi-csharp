...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class UnifiedHistoryLoanRate :  IEquatable<UnifiedHistoryLoanRate>, IValidatableObject
    {
        ...
        /// <param name="tier">VIP level for the floating rate to be retrieved.</param>
        /// <param name="tierUpRate">Floating rate corresponding to VIP level.</param>
        /// <param name="rates">Historical interest rate information, one data point per hour, array size determined by page and limit parameters from the API request, sorted by time from recent to distant.</param>
        ...
        /// </summary>
        /// <value>VIP level for the floating rate to be retrieved</value>
        ...
        /// </summary>
        /// <value>Floating rate corresponding to VIP level</value>
        ...
        /// </summary>
        /// <value>Historical interest rate information, one data point per hour, array size determined by page and limit parameters from the API request, sorted by time from recent to distant</value>
