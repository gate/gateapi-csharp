...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineObject11 :  IEquatable<InlineObject11>, IValidatableObject
    {
        ...
        public InlineObject11(string coin = default(string), string amount = default(string), string from = default(string), string to = default(string), string text = default(string))
        {
            // to ensure "coin" is required (not null)
            this.Coin = coin ?? throw new ArgumentNullException("coin", "coin is a required property for InlineObject11 and cannot be null");
            // to ensure "amount" is required (not null)
            this.Amount = amount ?? throw new ArgumentNullException("amount", "amount is a required property for InlineObject11 and cannot be null");
            // to ensure "from" is required (not null)
            this.From = from ?? throw new ArgumentNullException("from", "from is a required property for InlineObject11 and cannot be null");
            // to ensure "to" is required (not null)
            this.To = to ?? throw new ArgumentNullException("to", "to is a required property for InlineObject11 and cannot be null");
            this.Text = text;
        }
