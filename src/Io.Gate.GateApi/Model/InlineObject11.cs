...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineObject11 :  IEquatable<InlineObject11>, IValidatableObject
    {
        ...
        public InlineObject11(string text = default(string), string symbol = default(string), SideEnum side = default(SideEnum), TypeEnum? type = TypeEnum.LIMIT, TimeInForceEnum? timeInForce = TimeInForceEnum.GTC, string qty = default(string), string price = default(string), string quoteQty = default(string), ReduceOnlyEnum? reduceOnly = default(ReduceOnlyEnum?), PositionSideEnum? positionSide = default(PositionSideEnum?))
        {
            // to ensure "symbol" is required (not null)
            this.Symbol = symbol ?? throw new ArgumentNullException("symbol", "symbol is a required property for InlineObject11 and cannot be null");
            this.Side = side;
            this.Text = text;
            this.Type = type;
