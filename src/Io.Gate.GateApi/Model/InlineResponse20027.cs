...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse20027 :  IEquatable<InlineResponse20027>, IValidatableObject
    {
        ...
        public InlineResponse20027(string symbol = default(string), List<CrossexRuleRiskLimitsTiers> tiers = default(List<CrossexRuleRiskLimitsTiers>))
        {
            this.Symbol = symbol;
            this.Tiers = tiers;
        }
        ...
        public List<CrossexRuleRiskLimitsTiers> Tiers { get; set; }
