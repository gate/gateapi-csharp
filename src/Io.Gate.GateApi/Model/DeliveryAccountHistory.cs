...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeliveryAccountHistory :  IEquatable<DeliveryAccountHistory>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeliveryAccountHistory" /> class.
        /// </summary>
        ...
        public DeliveryAccountHistory(string dnw = default(string), string pnl = default(string), string fee = default(string), string refr = default(string), string fund = default(string), string pointDnw = default(string), string pointFee = default(string), string pointRefr = default(string), string bonusDnw = default(string), string bonusOffset = default(string))
        {
            this.Dnw = dnw;
            this.Pnl = pnl;
            this.Fee = fee;
        ...
        {
            return this.Equals(input as DeliveryAccountHistory);
        }

        /// <summary>
        /// Returns true if DeliveryAccountHistory instances are equal
        /// </summary>
        /// <param name="input">Instance of DeliveryAccountHistory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeliveryAccountHistory input)
        {
            if (input == null)
                return false;
