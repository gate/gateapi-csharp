...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse2001Data :  IEquatable<InlineResponse2001Data>, IValidatableObject
    {
        ...
        public InlineResponse2001Data(List<FixedTermProductSimple> list = default(List<FixedTermProductSimple>))
        {
            // to ensure "list" is required (not null)
            this.List = list ?? throw new ArgumentNullException("list", "list is a required property for InlineResponse2001Data and cannot be null");
        }
