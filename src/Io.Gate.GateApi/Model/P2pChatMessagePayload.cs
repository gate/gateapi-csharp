...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class P2pChatMessagePayload :  IEquatable<P2pChatMessagePayload>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as P2pChatMessagePayload);
        }

        /// <summary>
        /// Returns true if P2pChatMessagePayload instances are equal
        /// </summary>
        /// <param name="input">Instance of P2pChatMessagePayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(P2pChatMessagePayload input)
        {
            if (input == null)
                return false;
