...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse20017Data :  IEquatable<InlineResponse20017Data>, IValidatableObject
    {
        ...
        public InlineResponse20017Data(int isSell = default(int), int txid = default(int), int orderid = default(int), int timest = default(int), int lastPayTime = default(int), int remainPayTime = default(int), string currencyType = default(string), string wantType = default(string), string rate = default(string), string amount = default(string), string total = default(string), string status = default(string), string reasonId = default(string), string reasonDesc = default(string), int toastId = default(int), string cancelTime = default(string), int sellerConfirm = default(int), int inAppeal = default(int), int disputeTime = default(int), int cancelable = default(int), int hidePayment = default(int), string tradeTips = default(string), string showBank = default(string), string bankname = default(string), string bankbranch = default(string), string bankid = default(string), string bankHolderRealname = default(string), string showAli = default(string), string aliname = default(string), int isAlicode = default(int), string showWechat = default(string), string wename = default(string), string showOthers = default(string), List<string> payOthers = default(List<string>), string selPaytype = default(string), string itsUid = default(string), int itsIsBlueVip = default(int), int itsTier = default(int), string itsAvatar = default(string), string itsNickname = default(string), string itsRealname = default(string), int isFollow = default(int), int isBlack = default(int), int haveTraded = default(int), int appealUnread = default(int), int appealAllowCancel = default(int), string appealVerdictHasOpen = default(string), int imUnread = default(int), string message = default(string), string score = default(string), List<string> paymentVoucherUrl = default(List<string>), int completeNumber = default(int), string completeRateMonth = default(string), bool checkJournalAccount = default(bool), bool showJournalAccount = default(bool), int isFreezeGuarantee = default(int), string usdtLeftGuarantee = default(string), string guaranteeCurrType = default(string), int timestPaid = default(int), string state = default(string), int releaseCoinSwitch = default(int), string ownRealname = default(string), int confirmationUseTimeMonth = default(int), int isRiskUser = default(int), int isXt = default(int), int orderType = default(int), string symbol = default(string), int isShowReceive = default(int), int isTaker = default(int), int isOnline = default(int), bool showSellerContactInfo = default(bool), List<string> supportedPayTypes = default(List<string>))
        {
            ...
            this.CurrencyType = currencyType ?? throw new ArgumentNullException("currencyType", "currencyType is a required property for InlineResponse20017Data and cannot be null");
            // to ensure "wantType" is required (not null)
            this.WantType = wantType ?? throw new ArgumentNullException("wantType", "wantType is a required property for InlineResponse20017Data and cannot be null");
            // to ensure "rate" is required (not null)
            this.Rate = rate ?? throw new ArgumentNullException("rate", "rate is a required property for InlineResponse20017Data and cannot be null");
            // to ensure "amount" is required (not null)
            this.Amount = amount ?? throw new ArgumentNullException("amount", "amount is a required property for InlineResponse20017Data and cannot be null");
            // to ensure "total" is required (not null)
            this.Total = total ?? throw new ArgumentNullException("total", "total is a required property for InlineResponse20017Data and cannot be null");
            // to ensure "status" is required (not null)
            this.Status = status ?? throw new ArgumentNullException("status", "status is a required property for InlineResponse20017Data and cannot be null");
            // to ensure "reasonId" is required (not null)
            this.ReasonId = reasonId ?? throw new ArgumentNullException("reasonId", "reasonId is a required property for InlineResponse20017Data and cannot be null");
            // to ensure "reasonDesc" is required (not null)
            this.ReasonDesc = reasonDesc ?? throw new ArgumentNullException("reasonDesc", "reasonDesc is a required property for InlineResponse20017Data and cannot be null");
            this.ToastId = toastId;
            // to ensure "cancelTime" is required (not null)
            this.CancelTime = cancelTime ?? throw new ArgumentNullException("cancelTime", "cancelTime is a required property for InlineResponse20017Data and cannot be null");
            ...
            this.TradeTips = tradeTips ?? throw new ArgumentNullException("tradeTips", "tradeTips is a required property for InlineResponse20017Data and cannot be null");
            // to ensure "showBank" is required (not null)
            this.ShowBank = showBank ?? throw new ArgumentNullException("showBank", "showBank is a required property for InlineResponse20017Data and cannot be null");
            // to ensure "bankname" is required (not null)
            this.Bankname = bankname ?? throw new ArgumentNullException("bankname", "bankname is a required property for InlineResponse20017Data and cannot be null");
            // to ensure "bankbranch" is required (not null)
            this.Bankbranch = bankbranch ?? throw new ArgumentNullException("bankbranch", "bankbranch is a required property for InlineResponse20017Data and cannot be null");
            // to ensure "bankid" is required (not null)
            this.Bankid = bankid ?? throw new ArgumentNullException("bankid", "bankid is a required property for InlineResponse20017Data and cannot be null");
            // to ensure "bankHolderRealname" is required (not null)
            this.BankHolderRealname = bankHolderRealname ?? throw new ArgumentNullException("bankHolderRealname", "bankHolderRealname is a required property for InlineResponse20017Data and cannot be null");
            // to ensure "showAli" is required (not null)
            this.ShowAli = showAli ?? throw new ArgumentNullException("showAli", "showAli is a required property for InlineResponse20017Data and cannot be null");
            // to ensure "aliname" is required (not null)
            this.Aliname = aliname ?? throw new ArgumentNullException("aliname", "aliname is a required property for InlineResponse20017Data and cannot be null");
            this.IsAlicode = isAlicode;
            // to ensure "showWechat" is required (not null)
            this.ShowWechat = showWechat ?? throw new ArgumentNullException("showWechat", "showWechat is a required property for InlineResponse20017Data and cannot be null");
            // to ensure "wename" is required (not null)
            this.Wename = wename ?? throw new ArgumentNullException("wename", "wename is a required property for InlineResponse20017Data and cannot be null");
            // to ensure "showOthers" is required (not null)
            this.ShowOthers = showOthers ?? throw new ArgumentNullException("showOthers", "showOthers is a required property for InlineResponse20017Data and cannot be null");
            // to ensure "payOthers" is required (not null)
            this.PayOthers = payOthers ?? throw new ArgumentNullException("payOthers", "payOthers is a required property for InlineResponse20017Data and cannot be null");
            // to ensure "selPaytype" is required (not null)
            this.SelPaytype = selPaytype ?? throw new ArgumentNullException("selPaytype", "selPaytype is a required property for InlineResponse20017Data and cannot be null");
            // to ensure "itsUid" is required (not null)
            this.ItsUid = itsUid ?? throw new ArgumentNullException("itsUid", "itsUid is a required property for InlineResponse20017Data and cannot be null");
            this.ItsIsBlueVip = itsIsBlueVip;
            this.ItsTier = itsTier;
            // to ensure "itsAvatar" is required (not null)
            this.ItsAvatar = itsAvatar ?? throw new ArgumentNullException("itsAvatar", "itsAvatar is a required property for InlineResponse20017Data and cannot be null");
            // to ensure "itsNickname" is required (not null)
            this.ItsNickname = itsNickname ?? throw new ArgumentNullException("itsNickname", "itsNickname is a required property for InlineResponse20017Data and cannot be null");
            // to ensure "itsRealname" is required (not null)
            this.ItsRealname = itsRealname ?? throw new ArgumentNullException("itsRealname", "itsRealname is a required property for InlineResponse20017Data and cannot be null");
            ...
            this.AppealVerdictHasOpen = appealVerdictHasOpen ?? throw new ArgumentNullException("appealVerdictHasOpen", "appealVerdictHasOpen is a required property for InlineResponse20017Data and cannot be null");
            this.ImUnread = imUnread;
            // to ensure "message" is required (not null)
            this.Message = message ?? throw new ArgumentNullException("message", "message is a required property for InlineResponse20017Data and cannot be null");
            // to ensure "score" is required (not null)
            this.Score = score ?? throw new ArgumentNullException("score", "score is a required property for InlineResponse20017Data and cannot be null");
            // to ensure "paymentVoucherUrl" is required (not null)
            this.PaymentVoucherUrl = paymentVoucherUrl ?? throw new ArgumentNullException("paymentVoucherUrl", "paymentVoucherUrl is a required property for InlineResponse20017Data and cannot be null");
            this.CompleteNumber = completeNumber;
            // to ensure "completeRateMonth" is required (not null)
            this.CompleteRateMonth = completeRateMonth ?? throw new ArgumentNullException("completeRateMonth", "completeRateMonth is a required property for InlineResponse20017Data and cannot be null");
            ...
            this.UsdtLeftGuarantee = usdtLeftGuarantee ?? throw new ArgumentNullException("usdtLeftGuarantee", "usdtLeftGuarantee is a required property for InlineResponse20017Data and cannot be null");
            // to ensure "guaranteeCurrType" is required (not null)
            this.GuaranteeCurrType = guaranteeCurrType ?? throw new ArgumentNullException("guaranteeCurrType", "guaranteeCurrType is a required property for InlineResponse20017Data and cannot be null");
            this.TimestPaid = timestPaid;
            // to ensure "state" is required (not null)
            this.State = state ?? throw new ArgumentNullException("state", "state is a required property for InlineResponse20017Data and cannot be null");
            this.ReleaseCoinSwitch = releaseCoinSwitch;
            // to ensure "ownRealname" is required (not null)
            this.OwnRealname = ownRealname ?? throw new ArgumentNullException("ownRealname", "ownRealname is a required property for InlineResponse20017Data and cannot be null");
            this.ConfirmationUseTimeMonth = confirmationUseTimeMonth;
            this.IsRiskUser = isRiskUser;
            this.IsXt = isXt;
            this.OrderType = orderType;
            // to ensure "symbol" is required (not null)
            this.Symbol = symbol ?? throw new ArgumentNullException("symbol", "symbol is a required property for InlineResponse20017Data and cannot be null");
            ...
            this.SupportedPayTypes = supportedPayTypes ?? throw new ArgumentNullException("supportedPayTypes", "supportedPayTypes is a required property for InlineResponse20017Data and cannot be null");
        }
