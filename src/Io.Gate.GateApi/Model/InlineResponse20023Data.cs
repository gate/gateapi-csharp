...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse20023Data :  IEquatable<InlineResponse20023Data>, IValidatableObject
    {
        ...
        public InlineResponse20023Data(string fileKey = default(string))
        {
            // to ensure "fileKey" is required (not null)
            this.FileKey = fileKey ?? throw new ArgumentNullException("fileKey", "fileKey is a required property for InlineResponse20023Data and cannot be null");
        }
