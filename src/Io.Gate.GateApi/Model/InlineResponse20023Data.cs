...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse20023Data :  IEquatable<InlineResponse20023Data>, IValidatableObject
    {
        ...
        protected InlineResponse20023Data() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20023Data" /> class.
        /// </summary>
        ...
        public InlineResponse20023Data(List<InlineResponse20023DataMessages> messages = default(List<InlineResponse20023DataMessages>), string memo = default(string), bool hasHistory = default(bool), int txid = default(int), int sRVTM = default(int), string orderStatus = default(string))
        {
            // to ensure "messages" is required (not null)
            this.Messages = messages ?? throw new ArgumentNullException("messages", "messages is a required property for InlineResponse20023Data and cannot be null");
            // to ensure "memo" is required (not null)
            this.Memo = memo ?? throw new ArgumentNullException("memo", "memo is a required property for InlineResponse20023Data and cannot be null");
            this.HasHistory = hasHistory;
            this.Txid = txid;
            this.SRVTM = sRVTM;
            // to ensure "orderStatus" is required (not null)
            this.OrderStatus = orderStatus ?? throw new ArgumentNullException("orderStatus", "orderStatus is a required property for InlineResponse20023Data and cannot be null");
        }
        ...
        public List<InlineResponse20023DataMessages> Messages { get; set; }
