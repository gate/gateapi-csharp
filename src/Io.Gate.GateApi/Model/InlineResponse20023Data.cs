...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse20023Data :  IEquatable<InlineResponse20023Data>, IValidatableObject
    {
        ...
        public InlineResponse20023Data(int index = default(int), string asset = default(string), string fiatUnit = default(string), int advNo = default(int), string price = default(string), string maxSingleTransAmount = default(string), string minSingleTransAmount = default(string), string nickName = default(string))
        {
            this.Index = index;
            this.Asset = asset;
