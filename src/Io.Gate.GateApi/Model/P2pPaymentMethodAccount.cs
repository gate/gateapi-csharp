...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class P2pPaymentMethodAccount :  IEquatable<P2pPaymentMethodAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="P2pPaymentMethodAccount" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as P2pPaymentMethodAccount);
        }

        /// <summary>
        /// Returns true if P2pPaymentMethodAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of P2pPaymentMethodAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(P2pPaymentMethodAccount input)
        {
            if (input == null)
                return false;
