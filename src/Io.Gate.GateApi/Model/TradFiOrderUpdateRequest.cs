...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TradFiOrderUpdateRequest :  IEquatable<TradFiOrderUpdateRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TradFiOrderUpdateRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TradFiOrderUpdateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TradFiOrderUpdateRequest" /> class.
        /// </summary>
        ...
        public TradFiOrderUpdateRequest(string price = default(string), string priceTp = default(string), string priceSl = default(string))
        {
            // to ensure "price" is required (not null)
            this.Price = price ?? throw new ArgumentNullException("price", "price is a required property for TradFiOrderUpdateRequest and cannot be null");
        ...
        {
            return this.Equals(input as TradFiOrderUpdateRequest);
        }

        /// <summary>
        /// Returns true if TradFiOrderUpdateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TradFiOrderUpdateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TradFiOrderUpdateRequest input)
        {
            if (input == null)
                return false;
