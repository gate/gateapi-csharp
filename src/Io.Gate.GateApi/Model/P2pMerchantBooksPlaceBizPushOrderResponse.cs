...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class P2pMerchantBooksPlaceBizPushOrderResponse :  IEquatable<P2pMerchantBooksPlaceBizPushOrderResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="P2pMerchantBooksPlaceBizPushOrderResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as P2pMerchantBooksPlaceBizPushOrderResponse);
        }

        /// <summary>
        /// Returns true if P2pMerchantBooksPlaceBizPushOrderResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of P2pMerchantBooksPlaceBizPushOrderResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(P2pMerchantBooksPlaceBizPushOrderResponse input)
        {
            if (input == null)
                return false;
