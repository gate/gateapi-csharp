...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeliveryPosition :  IEquatable<DeliveryPosition>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeliveryPosition" /> class.
        /// </summary>
        ...
        public DeliveryPosition(string leverage = default(string), string riskLimit = default(string), string margin = default(string), PositionCloseOrder closeOrder = default(PositionCloseOrder), ModeEnum? mode = default(ModeEnum?), string crossLeverageLimit = default(string), long openTime = default(long))
        {
        ...
        /// </summary>
        /// <value>Current pending order quantity</value>
        ...
        /// </summary>
        /// <value>Update ID. The value increments by 1 each time the position is updated</value>
        ...
        {
            return this.Equals(input as DeliveryPosition);
        }

        /// <summary>
        /// Returns true if DeliveryPosition instances are equal
        /// </summary>
        /// <param name="input">Instance of DeliveryPosition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeliveryPosition input)
        {
            if (input == null)
                return false;
