...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20017DataMsgObj :  IEquatable<InlineResponse20017DataMsgObj>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20017DataMsgObj" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse20017DataMsgObj() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20017DataMsgObj" /> class.
        /// </summary>
        ...
        public InlineResponse20017DataMsgObj(string status = default(string), string text = default(string), List<string> paymentVoucher = default(List<string>), int reasonId = default(int), int toastId = default(int), string reasonMemo = default(string), int cancelTime = default(int), int sellerConfirm = default(int), string id = default(string), string accountDes = default(string), string payType = default(string), string file = default(string), string fileKey = default(string), string account = default(string), string memo = default(string), string code = default(string), string memoExt = default(string), string tradeTips = default(string), string realName = default(string), int isDelete = default(int), string payName = default(string))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id", "id is a required property for InlineResponse20017DataMsgObj and cannot be null");
            // to ensure "accountDes" is required (not null)
            this.AccountDes = accountDes ?? throw new ArgumentNullException("accountDes", "accountDes is a required property for InlineResponse20017DataMsgObj and cannot be null");
            // to ensure "payType" is required (not null)
            this.PayType = payType ?? throw new ArgumentNullException("payType", "payType is a required property for InlineResponse20017DataMsgObj and cannot be null");
            // to ensure "file" is required (not null)
            this.File = file ?? throw new ArgumentNullException("file", "file is a required property for InlineResponse20017DataMsgObj and cannot be null");
            // to ensure "fileKey" is required (not null)
            this.FileKey = fileKey ?? throw new ArgumentNullException("fileKey", "fileKey is a required property for InlineResponse20017DataMsgObj and cannot be null");
            // to ensure "account" is required (not null)
            this.Account = account ?? throw new ArgumentNullException("account", "account is a required property for InlineResponse20017DataMsgObj and cannot be null");
            // to ensure "memo" is required (not null)
            this.Memo = memo ?? throw new ArgumentNullException("memo", "memo is a required property for InlineResponse20017DataMsgObj and cannot be null");
            // to ensure "code" is required (not null)
            this.Code = code ?? throw new ArgumentNullException("code", "code is a required property for InlineResponse20017DataMsgObj and cannot be null");
            // to ensure "memoExt" is required (not null)
            this.MemoExt = memoExt ?? throw new ArgumentNullException("memoExt", "memoExt is a required property for InlineResponse20017DataMsgObj and cannot be null");
            // to ensure "tradeTips" is required (not null)
            this.TradeTips = tradeTips ?? throw new ArgumentNullException("tradeTips", "tradeTips is a required property for InlineResponse20017DataMsgObj and cannot be null");
            // to ensure "realName" is required (not null)
            this.RealName = realName ?? throw new ArgumentNullException("realName", "realName is a required property for InlineResponse20017DataMsgObj and cannot be null");
            this.IsDelete = isDelete;
            // to ensure "payName" is required (not null)
            this.PayName = payName ?? throw new ArgumentNullException("payName", "payName is a required property for InlineResponse20017DataMsgObj and cannot be null");
            this.Status = status;
            this.Text = text;
        ...
        {
            return this.Equals(input as InlineResponse20017DataMsgObj);
        }

        /// <summary>
        /// Returns true if InlineResponse20017DataMsgObj instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20017DataMsgObj to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20017DataMsgObj input)
        {
            if (input == null)
                return false;
