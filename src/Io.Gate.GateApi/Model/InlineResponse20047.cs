...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse20047 :  IEquatable<InlineResponse20047>, IValidatableObject
    {
        ...
        public InlineResponse20047(string coin = default(string), string exchangeType = default(string), string tier = default(string), string minValue = default(string), string maxValue = default(string), string discountRate = default(string))
        {
            // to ensure "coin" is required (not null)
            this.Coin = coin ?? throw new ArgumentNullException("coin", "coin is a required property for InlineResponse20047 and cannot be null");
            // to ensure "exchangeType" is required (not null)
            this.ExchangeType = exchangeType ?? throw new ArgumentNullException("exchangeType", "exchangeType is a required property for InlineResponse20047 and cannot be null");
            // to ensure "tier" is required (not null)
            this.Tier = tier ?? throw new ArgumentNullException("tier", "tier is a required property for InlineResponse20047 and cannot be null");
            // to ensure "minValue" is required (not null)
            this.MinValue = minValue ?? throw new ArgumentNullException("minValue", "minValue is a required property for InlineResponse20047 and cannot be null");
            // to ensure "maxValue" is required (not null)
            this.MaxValue = maxValue ?? throw new ArgumentNullException("maxValue", "maxValue is a required property for InlineResponse20047 and cannot be null");
            // to ensure "discountRate" is required (not null)
            this.DiscountRate = discountRate ?? throw new ArgumentNullException("discountRate", "discountRate is a required property for InlineResponse20047 and cannot be null");
        }
