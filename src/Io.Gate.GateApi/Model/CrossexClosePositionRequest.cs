...
namespace Io.Gate.GateApi.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrossexClosePositionRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CrossexClosePositionRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CrossexClosePositionRequest" /> class.
        /// </summary>
        ...
        public CrossexClosePositionRequest(string symbol = default(string), string positionSide = default(string))
        {
            // to ensure "symbol" is required (not null)
            this.Symbol = symbol ?? throw new ArgumentNullException("symbol", "symbol is a required property for CrossexClosePositionRequest and cannot be null");
        ...
        {
            return this.Equals(input as CrossexClosePositionRequest);
        }

        /// <summary>
        /// Returns true if CrossexClosePositionRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CrossexClosePositionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrossexClosePositionRequest input)
        {
            if (input == null)
                return false;
