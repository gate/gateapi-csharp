...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MyAdsListRequest :  IEquatable<MyAdsListRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as MyAdsListRequest);
        }

        /// <summary>
        /// Returns true if MyAdsListRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of MyAdsListRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MyAdsListRequest input)
        {
            if (input == null)
                return false;
