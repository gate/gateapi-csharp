...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CrossexPosition :  IEquatable<CrossexPosition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrossexPosition" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CrossexPosition);
        }

        /// <summary>
        /// Returns true if CrossexPosition instances are equal
        /// </summary>
        /// <param name="input">Instance of CrossexPosition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrossexPosition input)
        {
            if (input == null)
                return false;
