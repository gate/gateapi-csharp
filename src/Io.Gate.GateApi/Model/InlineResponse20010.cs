...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse20010 :  IEquatable<InlineResponse20010>, IValidatableObject
    {
        ...
        public InlineResponse20010(decimal timestamp = default(decimal), string method = default(string), int code = default(int), string message = default(string), InlineResponse20010Data data = default(InlineResponse20010Data), string version = default(string))
        {
            this.Timestamp = timestamp;
            // to ensure "method" is required (not null)
            this.Method = method ?? throw new ArgumentNullException("method", "method is a required property for InlineResponse20010 and cannot be null");
            this.Code = code;
            ...
            this.Version = version ?? throw new ArgumentNullException("version", "version is a required property for InlineResponse20010 and cannot be null");
        }
