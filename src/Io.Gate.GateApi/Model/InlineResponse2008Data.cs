...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse2008Data :  IEquatable<InlineResponse2008Data>, IValidatableObject
    {
        ...
        public InlineResponse2008Data(int total = default(int), List<InlineResponse2008DataItems> items = default(List<InlineResponse2008DataItems>))
        {
            this.Total = total;
            this.Items = items;
        }
        ...
        public List<InlineResponse2008DataItems> Items { get; set; }
