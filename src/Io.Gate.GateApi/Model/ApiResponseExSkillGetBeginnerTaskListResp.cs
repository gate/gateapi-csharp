...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseExSkillGetBeginnerTaskListResp :  IEquatable<ApiResponseExSkillGetBeginnerTaskListResp>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Business error code: 0 &#x3D; success, 1007 &#x3D; no task data, 1008 &#x3D; not logged in</value>
        ...
        public ApiResponseExSkillGetBeginnerTaskListRespData Data { get; set; }
        ...
        {
            return this.Equals(input as ApiResponseExSkillGetBeginnerTaskListResp);
        }

        /// <summary>
        /// Returns true if ApiResponseExSkillGetBeginnerTaskListResp instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseExSkillGetBeginnerTaskListResp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseExSkillGetBeginnerTaskListResp input)
        {
            if (input == null)
                return false;
