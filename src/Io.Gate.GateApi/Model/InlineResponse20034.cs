...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse20034 :  IEquatable<InlineResponse20034>, IValidatableObject
    {
        ...
        public InlineResponse20034(string quoteId = default(string), string validMs = default(string), string fromCoin = default(string), string toCoin = default(string), string fromAmount = default(string), string toAmount = default(string), string price = default(string))
        {
            // to ensure "quoteId" is required (not null)
            this.QuoteId = quoteId ?? throw new ArgumentNullException("quoteId", "quoteId is a required property for InlineResponse20034 and cannot be null");
            // to ensure "validMs" is required (not null)
            this.ValidMs = validMs ?? throw new ArgumentNullException("validMs", "validMs is a required property for InlineResponse20034 and cannot be null");
            // to ensure "fromCoin" is required (not null)
            this.FromCoin = fromCoin ?? throw new ArgumentNullException("fromCoin", "fromCoin is a required property for InlineResponse20034 and cannot be null");
            // to ensure "toCoin" is required (not null)
            this.ToCoin = toCoin ?? throw new ArgumentNullException("toCoin", "toCoin is a required property for InlineResponse20034 and cannot be null");
            // to ensure "fromAmount" is required (not null)
            this.FromAmount = fromAmount ?? throw new ArgumentNullException("fromAmount", "fromAmount is a required property for InlineResponse20034 and cannot be null");
            // to ensure "toAmount" is required (not null)
            this.ToAmount = toAmount ?? throw new ArgumentNullException("toAmount", "toAmount is a required property for InlineResponse20034 and cannot be null");
            // to ensure "price" is required (not null)
            this.Price = price ?? throw new ArgumentNullException("price", "price is a required property for InlineResponse20034 and cannot be null");
        }
