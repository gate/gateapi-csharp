...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse20034 :  IEquatable<InlineResponse20034>, IValidatableObject
    {
        ...
        public InlineResponse20034(string symbol = default(string), string leverage = default(string))
        {
            ...
            this.Leverage = leverage ?? throw new ArgumentNullException("leverage", "leverage is a required property for InlineResponse20034 and cannot be null");
        }
