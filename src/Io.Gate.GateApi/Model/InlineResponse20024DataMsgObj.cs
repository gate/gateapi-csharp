...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20024DataMsgObj :  IEquatable<InlineResponse20024DataMsgObj>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20024DataMsgObj" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InlineResponse20024DataMsgObj);
        }

        /// <summary>
        /// Returns true if InlineResponse20024DataMsgObj instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20024DataMsgObj to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20024DataMsgObj input)
        {
            if (input == null)
                return false;
