...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse20036 :  IEquatable<InlineResponse20036>, IValidatableObject
    {
        ...
        public InlineResponse20036(string coin = default(string), string exchangeType = default(string), string hourInterestRate = default(string), string time = default(string))
        {
            // to ensure "coin" is required (not null)
            this.Coin = coin ?? throw new ArgumentNullException("coin", "coin is a required property for InlineResponse20036 and cannot be null");
            // to ensure "exchangeType" is required (not null)
            this.ExchangeType = exchangeType ?? throw new ArgumentNullException("exchangeType", "exchangeType is a required property for InlineResponse20036 and cannot be null");
            // to ensure "hourInterestRate" is required (not null)
            this.HourInterestRate = hourInterestRate ?? throw new ArgumentNullException("hourInterestRate", "hourInterestRate is a required property for InlineResponse20036 and cannot be null");
            // to ensure "time" is required (not null)
            this.Time = time ?? throw new ArgumentNullException("time", "time is a required property for InlineResponse20036 and cannot be null");
        }
